...
const textColor = computed(() => {
  if (!props.color) return '#fefeff' // رنگ پیش‌فرض سفید calendly
  return isWhiteColor(props.color) ? '#000000' : '#ffffff'
})

// رنگ پس‌زمینه
const backgroundFill = computed(() => {
  return props.color || '#006bff' // رنگ پیش‌فرض calendly
})
