<template>
  ...
  <path
     ...
     id="path6" />
  <path
     d="m 133.7,108.8 c 0,9.2 -7.5,16.8 -16.8,16.6 -9.8,-0.2 -16.4,-8.1 -16.3,-16.7 0,-8.4 6.4,-16.6 16.7,-16.5 10.6,0 16.5,8.7 16.4,16.6 z m -6,0 c 0,-5.9 -4.8,-10.6 -10.7,-10.6 -5.7,0 -10.5,4.8 -10.5,10.5 0,5.9 4.7,10.6 10.6,10.7 5.8,0 10.6,-4.8 10.6,-10.6 z"
     :fill="contrastColor"
     id="path8" />
  <path
     d="m 98.2,108.8 c 0,9.2 -7.4,16.6 -16.6,16.6 -9.1,0 -16.5,-7.5 -16.5,-16.7 0,-7.9 6,-16.6 16.6,-16.5 10.7,0 16.6,8.7 16.5,16.6 z m -6,0 c 0,-5.9 -4.8,-10.6 -10.7,-10.6 -5.8,0 -10.5,4.8 -10.5,10.7 0,5.8 4.8,10.5 10.6,10.5 5.8,0 10.6,-4.8 10.5,-10.6 z"
     :fill="contrastColor"
     id="path10" />
  <path
     d="m 182.1,125.4 c 0,-2.8 0,-5.5 0,-8.3 0,-4.3 0,-8.5 0,-12.8 0.2,0.3 0.2,0.7 0.2,1.1 0,6.3 0,12.7 0,19 0,0.4 0,0.7 -0.2,1 z"
     :fill="dynamicColor"
     id="path12" />
  <path
     d="m 150.5,92.3 c -0.8,0 -1.6,0 -2.5,0 0.8,-0.3 1.6,-0.3 2.5,0 z"
     :fill="dynamicColor"
     id="path14" />
  <path
     d="m 181.1,125.5 c 0.2,0 0.5,0 0.7,0 -0.2,0.2 -0.5,0.2 -0.7,0 z"
     :fill="dynamicColor"
     id="path16" />
  <path
     d="m 127.8,108.8 c 0,5.8 -4.8,10.6 -10.6,10.6 -5.9,0 -10.6,-4.8 -10.6,-10.7 0,-5.8 4.8,-10.5 10.5,-10.5 5.9,0 10.7,4.7 10.7,10.6 z"
     :fill="dynamicColor"
     id="path18" />
  <path
     d="m 92.2,108.8 c 0,5.8 -4.8,10.6 -10.5,10.6 -5.8,0 -10.6,-4.7 -10.6,-10.5 0,-5.9 4.7,-10.6 10.5,-10.7 5.9,0 10.7,4.7 10.7,10.6 z"
     :fill="dynamicColor"
     id="path20" />
</svg>
</template>
