...
<g id="XMLID_632_">
	...
	<path id="XMLID_662_" fill-rule="evenodd" clip-rule="evenodd" :fill="props.color && props.filled ? props.color : 'url(#XMLID_2_)'" d="M294.1,260c-2.9,7.4-9.6,17.8-19.2,25.2
	...
	<g>
		<path id="XMLID_657_" :fill="textColor" d="M175.7,181.1c-0.4-3.6-1.6-6.2-4-8.6c-4.5-4.7-12.4-7.8-21.7-7.8c-9.3,0-17.2,3-21.7,7.8
		...
		<path id="XMLID_655_" :fill="textColor" d="M174.6,130.1c0,13.6-11,24.6-24.6,24.6s-24.6-11-24.6-24.6c0-13.6,11-24.6,24.6-24.6
			S174.6,116.6,174.6,130.1z"/>
		<path id="XMLID_653_" :fill="textColor" d="M149.7,33.2C92.3,33.4,45.3,80,44.5,137.4c-0.6,46.5,29.1,86.3,70.6,100.9
		...
		<path id="XMLID_651_" :fill="textColor" d="M147.3,68.2c-37.4,1.4-67.4,32.3-67.9,69.7c-0.3,24.6,12,46.4,30.9,59.3
