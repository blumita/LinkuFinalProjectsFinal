      ...
      >
        ...
        >
          <div
            v-show="modelValue"
            ref="bottomSheetRef"
            :class="['fixed left-0 right-0 bottom-0 bg-white dark:bg-gray-900 text-foreground flex flex-col rounded-t-2xl shadow-xl border border-border', 
