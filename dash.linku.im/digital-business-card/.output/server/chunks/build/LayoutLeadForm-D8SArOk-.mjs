...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="relative my-4 rounded-xl overflow-hidden transition duration-200 group cursor-pointer" data-v-4de5a52b><div class="h-40 rounded-xl overflow-hidden relative border border-black/10 shadow-sm" data-v-4de5a52b>`);
      _push(ssrRenderComponent(_component_ClientOnly, null, {
        fallback: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="h-full bg-gray-100 flex items-center justify-center" data-v-4de5a52b${_scopeId}><div class="text-center text-gray-400" data-v-4de5a52b${_scopeId}><i class="ti ti-map text-3xl mb-2 block" data-v-4de5a52b${_scopeId}></i> <p class="text-xs" data-v-4de5a52b${_scopeId}>\u067E\u06CC\u0634\u200C\u0646\u0645\u0627\u06CC\u0634 \u0646\u0642\u0634\u0647</p></div></div>`);
          } else {
            return [
      ...
      _push(` <div class="absolute inset-0 bg-transparent cursor-pointer" title="\u06A9\u0644\u06CC\u06A9 \u0628\u0631\u0627\u06CC \u0645\u0633\u06CC\u0631\u06CC\u0627\u0628\u06CC" data-v-4de5a52b></div></div> `);
      if (((_a = mapData.value) == null ? void 0 : _a.address) || ((_b = mapData.value) == null ? void 0 : _b.description)) {
        _push(`<div class="px-3 py-3 space-y-2" data-v-4de5a52b>`);
        if ((_c = mapData.value) == null ? void 0 : _c.address) {
          _push(`<div class="flex items-start gap-2" data-v-4de5a52b><i class="ti ti-map-pin text-primary text-base mt-0.5 flex-shrink-0" data-v-4de5a52b></i> <p class="text-sm text-foreground leading-relaxed break-words" data-v-4de5a52b>${ssrInterpolate(mapData.value.address)}</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(` `);
        if (((_d = mapData.value) == null ? void 0 : _d.description) && mapData.value.description.trim()) {
          _push(`<div class="text-xs text-muted-foreground leading-relaxed whitespace-pre-line break-words" data-v-4de5a52b>${ssrInterpolate(mapData.value.description)}</div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
      ...
      _push(ssrRenderComponent(__nuxt_component_0, {
        ...
        title: ((_e = mapData.value) == null ? void 0 : _e.title) || "\u0645\u0633\u06CC\u0631\u06CC\u0627\u0628\u06CC",
        size: "auto",
        closable: true
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="p-4 space-y-3" data-v-4de5a52b${_scopeId}>`);
            if (((_a2 = mapData.value) == null ? void 0 : _a2.address) || ((_b2 = mapData.value) == null ? void 0 : _b2.description)) {
              _push2(`<div class="bg-muted/50 rounded-xl p-4 mb-4 space-y-3" data-v-4de5a52b${_scopeId}>`);
              if ((_c2 = mapData.value) == null ? void 0 : _c2.address) {
                _push2(`<div class="flex items-start gap-2" data-v-4de5a52b${_scopeId}><i class="ti ti-map-pin text-primary text-lg mt-0.5 flex-shrink-0" data-v-4de5a52b${_scopeId}></i> <p class="text-sm text-foreground leading-relaxed break-words" data-v-4de5a52b${_scopeId}>${ssrInterpolate(mapData.value.address)}</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(` `);
              if (((_d2 = mapData.value) == null ? void 0 : _d2.description) && mapData.value.description.trim()) {
                _push2(`<div class="flex items-start gap-2" data-v-4de5a52b${_scopeId}><i class="ti ti-info-circle text-muted-foreground text-lg mt-0.5 flex-shrink-0" data-v-4de5a52b${_scopeId}></i> <p class="text-xs text-muted-foreground leading-relaxed whitespace-pre-line break-words" data-v-4de5a52b${_scopeId}>${ssrInterpolate(mapData.value.description)}</p></div>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div>`);
            ...
            _push2(` <p class="text-sm text-muted-foreground text-center mb-4" data-v-4de5a52b${_scopeId}>\u0645\u0633\u06CC\u0631 \u0631\u0627 \u0628\u0627 \u06A9\u062F\u0627\u0645 \u0627\u067E\u0644\u06CC\u06A9\u06CC\u0634\u0646 \u0628\u0628\u06CC\u0646\u06CC\u062F\u061F</p> <a${ssrRenderAttr("href", googleMapsUrl.value)} target="_blank" rel="noopener noreferrer" class="w-full flex items-center gap-3 p-3 rounded-xl border border-border hover:bg-muted transition-colors" data-v-4de5a52b${_scopeId}><div class="w-10 h-10 rounded-lg bg-green-100 flex items-center justify-center" data-v-4de5a52b${_scopeId}><i class="ti ti-brand-google text-green-600 text-xl" data-v-4de5a52b${_scopeId}></i></div> <div class="flex-1 text-right" data-v-4de5a52b${_scopeId}><p class="font-medium text-foreground" data-v-4de5a52b${_scopeId}>Google Maps</p> <p class="text-xs text-muted-foreground" data-v-4de5a52b${_scopeId}>\u0645\u0633\u06CC\u0631\u06CC\u0627\u0628\u06CC \u0628\u0627 \u06AF\u0648\u06AF\u0644 \u0645\u067E</p></div> <i class="ti ti-route text-muted-foreground" data-v-4de5a52b${_scopeId}></i></a> `);
            if (isMobile.value) {
              _push2(`<a${ssrRenderAttr("href", wazeUrl.value)} target="_blank" rel="noopener noreferrer" class="w-full flex items-center gap-3 p-3 rounded-xl border border-border hover:bg-muted transition-colors" data-v-4de5a52b${_scopeId}><div class="w-10 h-10 rounded-lg bg-blue-100 flex items-center justify-center" data-v-4de5a52b${_scopeId}><i class="ti ti-brand-waze text-blue-600 text-xl" data-v-4de5a52b${_scopeId}></i></div> <div class="flex-1 text-right" data-v-4de5a52b${_scopeId}><p class="font-medium text-foreground" data-v-4de5a52b${_scopeId}>Waze</p> <p class="text-xs text-muted-foreground" data-v-4de5a52b${_scopeId}>\u0645\u0633\u06CC\u0631\u06CC\u0627\u0628\u06CC \u0628\u0627 \u0648\u06CC\u0632</p></div> <i class="ti ti-route text-muted-foreground" data-v-4de5a52b${_scopeId}></i></a>`);
            } else {
              _push2(`<!---->`);
            }
            _push2(` <a${ssrRenderAttr("href", neshanUrl.value)} target="_blank" rel="noopener noreferrer" class="w-full flex items-center gap-3 p-3 rounded-xl border border-border hover:bg-muted transition-colors" data-v-4de5a52b${_scopeId}><div class="w-10 h-10 rounded-lg bg-orange-100 flex items-center justify-center" data-v-4de5a52b${_scopeId}><i class="ti ti-map-2 text-orange-600 text-xl" data-v-4de5a52b${_scopeId}></i></div> <div class="flex-1 text-right" data-v-4de5a52b${_scopeId}><p class="font-medium text-foreground" data-v-4de5a52b${_scopeId}>\u0646\u0634\u0627\u0646</p> <p class="text-xs text-muted-foreground" data-v-4de5a52b${_scopeId}>\u0645\u0633\u06CC\u0631\u06CC\u0627\u0628\u06CC \u0628\u0627 \u0646\u0634\u0627\u0646</p></div> <i class="ti ti-route text-muted-foreground" data-v-4de5a52b${_scopeId}></i></a> <button class="w-full flex items-center gap-3 p-3 rounded-xl border border-border hover:bg-muted transition-colors" data-v-4de5a52b${_scopeId}><div class="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center" data-v-4de5a52b${_scopeId}><i class="ti ti-copy text-gray-600 text-xl" data-v-4de5a52b${_scopeId}></i></div> <div class="flex-1 text-right" data-v-4de5a52b${_scopeId}><p class="font-medium text-foreground" data-v-4de5a52b${_scopeId}>\u06A9\u067E\u06CC \u0645\u062E\u062A\u0635\u0627\u062A</p> <p class="text-xs text-muted-foreground" data-v-4de5a52b${_scopeId}>${ssrInterpolate((_f = (_e2 = mapData.value) == null ? void 0 : _e2.latitude) == null ? void 0 : _f.toFixed(6))}, ${ssrInterpolate((_h = (_g = mapData.value) == null ? void 0 : _g.longitude) == null ? void 0 : _h.toFixed(6))}</p></div></button></div>`);
          } else {
            return [
              createVNode("div", { class: "p-4 space-y-3" }, [
                ((_i = mapData.value) == null ? void 0 : _i.address) || ((_j = mapData.value) == null ? void 0 : _j.description) ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "bg-muted/50 rounded-xl p-4 mb-4 space-y-3"
                }, [
                  ((_k = mapData.value) == null ? void 0 : _k.address) ? (openBlock(), createBlock("div", {
                    key: 0,
                    class: "flex items-start gap-2"
                  }, [
                    createVNode("i", { class: "ti ti-map-pin text-primary text-lg mt-0.5 flex-shrink-0" }),
                    createTextVNode(),
                    createVNode("p", { class: "text-sm text-foreground leading-relaxed break-words" }, toDisplayString(mapData.value.address), 1)
                  ])) : createCommentVNode("", true),
                  createTextVNode(),
                  ((_l = mapData.value) == null ? void 0 : _l.description) && mapData.value.description.trim() ? (openBlock(), createBlock("div", {
                    key: 1,
                    class: "flex items-start gap-2"
                  }, [
                    createVNode("i", { class: "ti ti-info-circle text-muted-foreground text-lg mt-0.5 flex-shrink-0" }),
                    createTextVNode(),
                    createVNode("p", { class: "text-xs text-muted-foreground leading-relaxed whitespace-pre-line break-words" }, toDisplayString(mapData.value.description), 1)
                  ])) : createCommentVNode("", true)
                ])) : createCommentVNode("", true),
                createTextVNode(),
                ...
                createVNode("button", {
                  ...
                  createVNode("div", { class: "flex-1 text-right" }, [
                    ...
                    createTextVNode(),
                    createVNode("p", { class: "text-xs text-muted-foreground" }, toDisplayString((_n = (_m = mapData.value) == null ? void 0 : _m.latitude) == null ? void 0 : _n.toFixed(6)) + ", " + toDisplayString((_p = (_o = mapData.value) == null ? void 0 : _o.longitude) == null ? void 0 : _p.toFixed(6)), 1)
                  ])
                ])
              ])
            ];
...
const map = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-4de5a52b"]]);
...
//# sourceMappingURL=LayoutLeadForm-D8SArOk-.mjs.map
