  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!loading.value && messages.value.length === 0) {
        _push(`<div class="text-center py-12"><div class="w-16 h-16 rounded-xl bg-primary/10 flex items-center justify-center mx-auto mb-4"><i class="ti ti-wheel text-primary text-2xl opacity-50"></i></div> <h3 class="text-foreground font-medium mb-2">\u0647\u06CC\u0686 \u067E\u06CC\u0627\u0645\u06CC \u0648\u062C\u0648\u062F \u0646\u062F\u0627\u0631\u062F</h3> <p class="text-muted-foreground text-sm">\u0647\u0646\u0648\u0632 \u0647\u06CC\u0686 \u067E\u06CC\u0627\u0645\u06CC \u0627\u0632 \u0686\u0631\u062E \u0634\u0627\u0646\u0633 \u062F\u0631\u06CC\u0627\u0641\u062A \u0646\u0634\u062F\u0647 \u0627\u0633\u062A</p></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div></div></div>`);
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/inbox/SpinWheelPage.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=SpinWheelPage-B1hu4JTG.mjs.map
