...
import { u as useAsyncData, _ as _imports_1, a as _imports_0, b as _sfc_main$1, P as PreviewItems, c as _sfc_main$6, d as _sfc_main$5 } from './LayoutLeadForm-Rod-lE9A.mjs';
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isCardActivated.value) {
        _push(`<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center p-4" data-v-499d967e><div class="bg-white rounded-3xl p-8 sm:p-12 max-w-md w-full text-center" data-v-499d967e><div class="mb-8" data-v-499d967e><img${ssrRenderAttr("src", _imports_1)} alt="Linku Logo" class="w-24 h-24 mx-auto object-contain" data-v-499d967e></div> <div class="w-20 h-20 bg-amber-50 rounded-full flex items-center justify-center mx-auto mb-6" data-v-499d967e><svg class="w-10 h-10 text-amber-500" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-v-499d967e><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z" data-v-499d967e></path></svg></div> <h1 class="text-2xl font-bold text-gray-900 mb-4" data-v-499d967e>
        \u0627\u06CC\u0646 \u0635\u0641\u062D\u0647 \u0647\u0646\u0648\u0632 \u0641\u0639\u0627\u0644 \u0646\u0634\u062F\u0647 \u0627\u0633\u062A
      </h1> <p class="text-gray-600 mb-8 leading-relaxed" data-v-499d967e>
        \u0627\u06CC\u0646 \u06A9\u0627\u0631\u062A \u0648\u06CC\u0632\u06CC\u062A \u062F\u06CC\u062C\u06CC\u062A\u0627\u0644 \u0647\u0646\u0648\u0632 \u062A\u0648\u0633\u0637 \u0635\u0627\u062D\u0628 \u0622\u0646 \u0641\u0639\u0627\u0644\u200C\u0633\u0627\u0632\u06CC \u0646\u0634\u062F\u0647 \u0627\u0633\u062A.
        <br data-v-499d967e>
        \u0628\u0631\u0627\u06CC \u0641\u0639\u0627\u0644\u200C\u0633\u0627\u0632\u06CC\u060C \u0635\u0627\u062D\u0628 \u06A9\u0627\u0631\u062A \u0628\u0627\u06CC\u062F \u0648\u0627\u0631\u062F \u067E\u0646\u0644 \u06A9\u0627\u0631\u0628\u0631\u06CC \u0644\u06CC\u0646\u06A9\u0648 \u0634\u0648\u062F.
      </p> <div class="space-y-3" data-v-499d967e><a href="https://linku.im" class="block w-full py-3 px-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-semibold rounded-xl hover:from-blue-700 hover:to-blue-800 transition-all duration-300" data-v-499d967e>
          \u0648\u0631\u0648\u062F \u0628\u0647 \u0644\u06CC\u0646\u06A9\u0648
        </a></div> <div class="mt-10 pt-6 border-t border-gray-100" data-v-499d967e><div class="flex items-center justify-center gap-2 text-sm text-gray-500" data-v-499d967e><img${ssrRenderAttr("src", _imports_0)} alt="Linku" class="w-4 h-4" data-v-499d967e> <span data-v-499d967e>\u06A9\u0627\u0631\u062A \u0648\u06CC\u0632\u06CC\u062A \u062F\u06CC\u062C\u06CC\u062A\u0627\u0644</span> <span class="font-bold text-gray-700" data-v-499d967e>\u0644\u06CC\u0646\u06A9\u0648</span></div></div></div></div>`);
      } else if (!isLoading.value) {
        _push(`<div data-v-499d967e>`);
        _push(ssrRenderComponent(InfoToast, {
          visible: showToast.value,
          message: toastMessage.value,
          icon: toastIcon.value
        }, null, _parent));
        _push(` <div class="w-full h-screen flex flex-col overflow-hidden relative scrollbar-hide"${ssrRenderAttr("dir", ((_a = unref(formData)) == null ? void 0 : _a.layout) === "left" ? "ltr" : "rtl")} data-v-499d967e><div class="absolute inset-0 w-full h-full pointer-events-none" style="${ssrRenderStyle({ backgroundColor: getLighterColor((_d = (_c = (_b = unref(formData)) == null ? void 0 : _b.themeColor) == null ? void 0 : _c.background) != null ? _d : "#ffffff"), zIndex: 0, transition: "background-color 0.3s" })}" data-v-499d967e></div> <div class="relative z-10 flex-1 pb-8 overflow-auto scrollbar-hide" data-v-499d967e><div class="${ssrRenderClass([
        ...
        if ((_f = unref(formData)) == null ? void 0 : _f.coverImage) {
          _push(`<div class="absolute inset-0 bg-cover bg-center" style="${ssrRenderStyle(`background-image: url('${unref(formData).coverImage}')`)}" data-v-499d967e></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(` <div class="absolute top-4 ltr:right-4 rtl:left-4 z-20" data-v-499d967e><button type="button" class="w-10 h-10 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-white/20 transition-all duration-300 border border-white/20" data-v-499d967e><i class="ti ti-dots-vertical text-sm" data-v-499d967e></i></button> <div style="${ssrRenderStyle(showOptionsMenu.value ? null : { display: "none" })}" class="absolute top-12 ltr:right-0 rtl:left-0 bg-white/95 backdrop-blur-lg rounded-xl shadow-2xl border border-white/30 py-2 min-w-[160px] z-30" data-v-499d967e><button type="button" class="w-full text-right px-4 py-3 hover:bg-gray-50/80 flex items-center gap-3 text-gray-700 transition-all duration-200" data-v-499d967e><i class="ti ti-share text-gray-600" data-v-499d967e></i>
                \u0627\u0634\u062A\u0631\u0627\u06A9\u200C\u06AF\u0630\u0627\u0631\u06CC
              </button> <button type="button" class="w-full text-right px-4 py-3 hover:bg-gray-50/80 flex items-center gap-3 text-gray-700 transition-all duration-200" data-v-499d967e><i class="ti ti-flag text-gray-600" data-v-499d967e></i>
                \u06AF\u0632\u0627\u0631\u0634 \u0645\u062D\u062A\u0648\u0627
              </button></div></div> `);
        ...
        if (((_k = unref(formData)) == null ? void 0 : _k.layout) !== "portrait") {
          _push(`<div class="${ssrRenderClass([
            ...
            // default برای right
          ])}" data-v-499d967e><div class="relative" data-v-499d967e><div class="rounded-full border-4 border-white bg-slate-200 w-28 h-28 overflow-hidden" data-v-499d967e>`);
          if ((_n = unref(formData)) == null ? void 0 : _n.profileImage) {
            _push(`<img${ssrRenderAttr("src", (_o = unref(formData)) == null ? void 0 : _o.profileImage)} class="w-full h-full object-cover" data-v-499d967e>`);
          } else {
            _push(`<!---->`);
          }
          ...
          if ((_r = unref(formData)) == null ? void 0 : _r.logoImage) {
            _push(`<img${ssrRenderAttr("src", (_s = unref(formData)) == null ? void 0 : _s.logoImage)} class="w-full h-full object-cover" data-v-499d967e>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div></div></div>`);
        ...
        _push(`</div> <div class="${ssrRenderClass([
          ...
          // default برای right
        ])}" data-v-499d967e><div class="${ssrRenderClass([
          "space-y-2",
        ...
        ])}" style="${ssrRenderStyle({ color: iconText.value })}" data-v-499d967e>`);
        if ((_y = unref(formData)) == null ? void 0 : _y.name) {
          ...
          if (((_C = unref(formData)) == null ? void 0 : _C.layout) === "portrait") {
            _push(`<div class="w-12 h-12 rounded-full shadow-md border border-gray-200 overflow-hidden bg-white flex-shrink-0 order-2" data-v-499d967e>`);
            if ((_D = unref(formData)) == null ? void 0 : _D.logoImage) {
              _push(`<img${ssrRenderAttr("src", (_E = unref(formData)) == null ? void 0 : _E.logoImage)} class="w-full h-full object-cover" data-v-499d967e>`);
            } else {
              _push(`<div class="w-full h-full bg-gray-300" data-v-499d967e></div>`);
            }
            _push(`</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(` <div class="${ssrRenderClass([((_F = unref(formData)) == null ? void 0 : _F.layout) === "portrait" ? "order-1" : "", "flex items-center gap-2"])}" data-v-499d967e>${ssrInterpolate((_G = unref(formData)) == null ? void 0 : _G.name)} <span class="${ssrRenderClass(((_H = unref(formData)) == null ? void 0 : _H.layout) === "left" ? "ml-2" : "mr-2")}" data-v-499d967e>`);
          if (enableBlueTick.value) {
            _push(`<i class="ti ti-rosette-discount-check text-blue-500" data-v-499d967e></i>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</span></div></div>`);
          ...
          if (unref(formData).layout === "portrait") {
            ...
            if (unref(formData).logoImage) {
              _push(`<img${ssrRenderAttr("src", unref(formData).logoImage)} class="w-full h-full object-cover" data-v-499d967e>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</div>`);
          ...
          _push(` <div class="${ssrRenderClass([unref(formData).layout === "portrait" ? "order-1" : "", "flex items-center gap-2"])}" data-v-499d967e></div></div>`);
        }
        _push(` `);
        if (unref(formData).job) {
          _push(`<div class="${ssrRenderClass([
            ...
            // default
          ])}" data-v-499d967e><i class="ti ti-briefcase text-sm" style="${ssrRenderStyle({ color: iconColor.value })}" data-v-499d967e></i> ${ssrInterpolate(unref(formData).job)}</div>`);
        } else {
          _push(`<div class="${ssrRenderClass([
        ...
        if (unref(formData).company) {
          _push(`<div class="${ssrRenderClass([
            ...
            unref(formData).layout === "center" ? "justify-center" : unref(formData).layout === "portrait" ? "justify-start" : unref(formData).layout === "left" ? "justify-start" : "justify-start"
            // default
          ])}" data-v-499d967e><i class="ti ti-building text-sm" style="${ssrRenderStyle({ color: iconColor.value })}" data-v-499d967e></i> ${ssrInterpolate(unref(formData).company)}</div>`);
        } else {
          _push(`<div class="${ssrRenderClass([
        ...
        if ((_K = unref(formData)) == null ? void 0 : _K.location) {
          _push(`<div class="${ssrRenderClass([
            ...
            unref(formData).layout === "center" ? "justify-center" : unref(formData).layout === "portrait" ? "justify-start" : unref(formData).layout === "left" ? "justify-start" : "justify-start"
            // default
          ])}" data-v-499d967e><i class="ti ti-map-pin text-sm" style="${ssrRenderStyle({ color: iconColor.value })}" data-v-499d967e></i> ${ssrInterpolate((_L = unref(formData)) == null ? void 0 : _L.location)}</div>`);
        } else {
          _push(`<div class="${ssrRenderClass([
            "text-sm text-black flex items-center gap-1",
            unref(formData).layout === "center" ? "justify-center" : unref(formData).layout === "portrait" ? "justify-start" : unref(formData).layout === "left" ? "justify-start" : "justify-start"
        ...
        if (unref(formData).bio) {
          ...
          ])}" style="${ssrRenderStyle({ "overflow": "hidden", "display": "-webkit-box", "-webkit-line-clamp": "3", "-webkit-box-orient": "vertical", "line-clamp": "3", "white-space": "pre-line" })}" data-v-499d967e>${ssrInterpolate(unref(formData).bio)}</div>`);
        } else {
          _push(`<div class="${ssrRenderClass([
            "text-xs text-black",
            unref(formData).layout === "center" ? "text-center" : unref(formData).layout === "portrait" ? "text-justify" : "text-justify"
        ...
        if (unref(formData).saveContact) {
          ...
          })}" data-v-499d967e><i class="ti ti-download" data-v-499d967e></i> ${ssrInterpolate(unref(formData).saveContact)}</button>`);
        } else {
          _push(`<button disabled class="w-full py-3 rounded-full text-center font-bold text-gray-400 bg-gray-200 flex items-center justify-center gap-2 cursor-not-allowed" data-v-499d967e><div class="w-5 h-5 bg-gray-300 rounded-full animate-pulse" data-v-499d967e></div> <div class="h-4 w-32 bg-gray-300 rounded animate-pulse" data-v-499d967e></div></button>`);
        }
        ...
        if (!unref(formData).removeBranding) {
          _push(`<div class="flex items-center justify-center py-6 px-6" data-v-499d967e>`);
          if (!unref(formData).removeBranding) {
            _push(`<div class="flex items-center justify-center py-6 px-6" data-v-499d967e><div class="flex items-center gap-2 text-xs text-gray-500 bg-gray-100/50 px-4 py-2 rounded-full border border-gray-200/50 backdrop-blur-sm" data-v-499d967e><img${ssrRenderAttr("src", _imports_0)} alt="Linku Logo" class="w-4 h-4" data-v-499d967e> <span class="font-medium" data-v-499d967e>\u0633\u0627\u062E\u062A\u0647 \u0634\u062F\u0647 \u0628\u0627</span> <span class="font-bold text-gray-700" data-v-499d967e>\u0644\u06CC\u0646\u06A9\u0648</span></div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div>`);
        ...
        _push(ssrRenderComponent(__nuxt_component_0, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="space-y-4" data-v-499d967e${_scopeId}><div class="space-y-3" data-v-499d967e${_scopeId}><button class="w-full flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-lg transition-colors border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600" data-v-499d967e${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-499d967e${_scopeId}><i class="ti ti-brand-telegram text-white text-sm" data-v-499d967e${_scopeId}></i></div> <span class="font-medium text-gray-800 dark:text-gray-200 text-right flex-1" data-v-499d967e${_scopeId}>\u062A\u0644\u06AF\u0631\u0627\u0645</span></button> <button class="w-full flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 hover:bg-green-50 dark:hover:bg-green-900/30 rounded-lg transition-colors border border-gray-200 dark:border-gray-700 hover:border-green-300 dark:hover:border-green-600" data-v-499d967e${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-499d967e${_scopeId}><i class="ti ti-brand-whatsapp text-white text-sm" data-v-499d967e${_scopeId}></i></div> <span class="font-medium text-gray-800 dark:text-gray-200 text-right flex-1" data-v-499d967e${_scopeId}>\u0648\u0627\u062A\u0633\u0627\u067E</span></button> <button class="w-full flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 hover:bg-pink-50 dark:hover:bg-pink-900/30 rounded-lg transition-colors border border-gray-200 dark:border-gray-700 hover:border-pink-300 dark:hover:border-pink-600" data-v-499d967e${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-499d967e${_scopeId}><i class="ti ti-brand-instagram text-white text-sm" data-v-499d967e${_scopeId}></i></div> <span class="font-medium text-gray-800 dark:text-gray-200 text-right flex-1" data-v-499d967e${_scopeId}>\u0627\u06CC\u0646\u0633\u062A\u0627\u06AF\u0631\u0627\u0645</span></button> <button class="w-full flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-lg transition-colors border border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600" data-v-499d967e${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-499d967e${_scopeId}><i class="ti ti-brand-linkedin text-white text-sm" data-v-499d967e${_scopeId}></i></div> <span class="font-medium text-gray-800 dark:text-gray-200 text-right flex-1" data-v-499d967e${_scopeId}>\u0644\u06CC\u0646\u06A9\u062F\u06CC\u0646</span></button> <button class="w-full flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors border border-gray-200 dark:border-gray-700 hover:border-gray-400 dark:hover:border-gray-500" data-v-499d967e${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-499d967e${_scopeId}><i class="ti ti-brand-x text-white text-sm" data-v-499d967e${_scopeId}></i></div> <span class="font-medium text-gray-800 dark:text-gray-200 text-right flex-1" data-v-499d967e${_scopeId}>\u0627\u06CC\u06A9\u0633</span></button> <button class="w-full flex items-center gap-3 p-3 bg-gray-50 dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors border border-gray-200 dark:border-gray-700 hover:border-gray-400 dark:hover:border-gray-500" data-v-499d967e${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-499d967e${_scopeId}><i class="ti ti-copy text-white text-sm" data-v-499d967e${_scopeId}></i></div> <span class="font-medium text-gray-800 dark:text-gray-200 text-right flex-1" data-v-499d967e${_scopeId}>\u06A9\u067E\u06CC \u0644\u06CC\u0646\u06A9</span></button></div> <button class="w-full py-3 px-4 bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-200 rounded-xl font-medium hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors" data-v-499d967e${_scopeId}>
            \u0627\u0646\u0635\u0631\u0627\u0641
          </button></div>`);
            } else {
              return [
        ...
        _push(ssrRenderComponent(__nuxt_component_0, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="space-y-6" data-v-499d967e${_scopeId}><div class="space-y-3" data-v-499d967e${_scopeId}><h4 class="font-semibold text-gray-700" data-v-499d967e${_scopeId}>\u0646\u0648\u0639 \u06AF\u0632\u0627\u0631\u0634:</h4> <div class="space-y-2" data-v-499d967e${_scopeId}><label class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors" data-v-499d967e${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(reportType.value, "inappropriate")) ? " checked" : ""} value="inappropriate" class="text-red-500" data-v-499d967e${_scopeId}> <div class="flex items-center gap-2" data-v-499d967e${_scopeId}><div class="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-499d967e${_scopeId}><i class="ti ti-alert-triangle text-white text-xs" data-v-499d967e${_scopeId}></i></div> <span class="text-gray-800" data-v-499d967e${_scopeId}>\u0645\u062D\u062A\u0648\u0627\u06CC \u0646\u0627\u0645\u0646\u0627\u0633\u0628</span></div></label> <label class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors" data-v-499d967e${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(reportType.value, "spam")) ? " checked" : ""} value="spam" class="text-orange-500" data-v-499d967e${_scopeId}> <div class="flex items-center gap-2" data-v-499d967e${_scopeId}><div class="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-499d967e${_scopeId}><i class="ti ti-mail-x text-white text-xs" data-v-499d967e${_scopeId}></i></div> <span class="text-gray-800" data-v-499d967e${_scopeId}>\u0627\u0633\u067E\u0645 \u06CC\u0627 \u062A\u0628\u0644\u06CC\u063A\u0627\u062A</span></div></label> <label class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors" data-v-499d967e${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(reportType.value, "fake")) ? " checked" : ""} value="fake" class="text-blue-500" data-v-499d967e${_scopeId}> <div class="flex items-center gap-2" data-v-499d967e${_scopeId}><div class="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-499d967e${_scopeId}><i class="ti ti-user-x text-white text-xs" data-v-499d967e${_scopeId}></i></div> <span class="text-gray-800" data-v-499d967e${_scopeId}>\u0647\u0648\u06CC\u062A \u062C\u0639\u0644\u06CC</span></div></label> <label class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors" data-v-499d967e${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(reportType.value, "other")) ? " checked" : ""} value="other" class="text-gray-500" data-v-499d967e${_scopeId}> <div class="flex items-center gap-2" data-v-499d967e${_scopeId}><div class="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-499d967e${_scopeId}><i class="ti ti-dots text-white text-xs" data-v-499d967e${_scopeId}></i></div> <span class="text-gray-800" data-v-499d967e${_scopeId}>\u0633\u0627\u06CC\u0631 \u0645\u0648\u0627\u0631\u062F</span></div></label></div></div> <div class="space-y-3" data-v-499d967e${_scopeId}><h4 class="font-semibold text-gray-700" data-v-499d967e${_scopeId}>\u062A\u0648\u0636\u06CC\u062D\u0627\u062A (\u0627\u062E\u062A\u06CC\u0627\u0631\u06CC):</h4> <textarea placeholder="\u0644\u0637\u0641\u0627\u064B \u062A\u0648\u0636\u06CC\u062D\u0627\u062A \u0628\u06CC\u0634\u062A\u0631\u06CC \u062F\u0631 \u0645\u0648\u0631\u062F \u06AF\u0632\u0627\u0631\u0634 \u062E\u0648\u062F \u0627\u0631\u0627\u0626\u0647 \u062F\u0647\u06CC\u062F..." class="w-full p-4 border border-gray-200 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" rows="4" data-v-499d967e${_scopeId}>${ssrInterpolate(reportDescription.value)}</textarea></div> <div class="flex gap-3 pt-4 border-t border-gray-200" data-v-499d967e${_scopeId}><button class="flex-1 py-3 px-4 bg-gray-200 text-gray-700 rounded-xl font-medium hover:bg-gray-300 transition-colors" data-v-499d967e${_scopeId}>
              \u0627\u0646\u0635\u0631\u0627\u0641
            </button> <button${ssrIncludeBooleanAttr(!reportType.value) ? " disabled" : ""} class="${ssrRenderClass([{ "bg-gray-300 !text-gray-500 cursor-not-allowed": !reportType.value }, "flex-1 py-3 px-4 rounded-xl font-medium transition-colors text-white hover:opacity-90"])}" style="${ssrRenderStyle(reportType.value ? { backgroundColor: iconBg.value } : { backgroundColor: "#d1d5db" })}" data-v-499d967e${_scopeId}>
              \u0627\u0631\u0633\u0627\u0644 \u06AF\u0632\u0627\u0631\u0634
            </button></div> <p class="text-xs text-gray-500 text-center" data-v-499d967e${_scopeId}>
        ...
        if (unref(formData).isLeadCaptureEnabled) {
          _push(`<div class="fixed inset-0 bg-white/70 bg-opacity-50 z-50 w-full p-4 backdrop-blur-[1px]" style="${ssrRenderStyle({ "display": "grid", "place-items": "center" })}" data-v-499d967e>`);
        ...
        _push(`<div class="fixed inset-0 flex flex-col items-center justify-center bg-white text-black z-50" data-v-499d967e><img${ssrRenderAttr("src", _imports_1)} alt="Logo" class="w-32 h-32 mb-10 object-contain" data-v-499d967e> <div class="flex space-x-3" data-v-499d967e><span class="w-3 h-3 bg-black rounded-full animate-bounce [animation-delay:-0.3s]" data-v-499d967e></span> <span class="w-3 h-3 bg-black rounded-full animate-bounce [animation-delay:-0.15s]" data-v-499d967e></span> <span class="w-3 h-3 bg-black rounded-full animate-bounce" data-v-499d967e></span></div></div>`);
      }
    };
  }
};
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-499d967e"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-Dh-wDXhk.mjs.map
