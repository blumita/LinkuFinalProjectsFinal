import { defineComponent, computed, mergeProps, unref, useId, useSSRContext } from 'vue';
...
_sfc_main$1c.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/contact/address.vue");
...
_sfc_main$1b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/contact/call.vue");
...
_sfc_main$1a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/contact/contactcard.vue");
...
_sfc_main$19.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/contact/eitaa.vue");
...
const _sfc_main$18 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const gradientId = `email-gradient-${useId()}`;
    const isWhiteColor = (color) => {
      if (!color || color === "transparent") return false;
      const hex = color.replace("#", "").toLowerCase();
      return hex === "ffffff" || hex === "fff" || color.toLowerCase() === "white";
...
_sfc_main$18.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/contact/email.vue");
...
_sfc_main$17.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/contact/facetime.vue");
...
_sfc_main$16.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/contact/number.vue");
...
const _sfc_main$15 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const gradientId = `telegram-gradient-${useId()}`;
    const isWhiteColor = (color) => {
      if (!color || color === "transparent") return false;
      const hex = color.replace("#", "").toLowerCase();
      return hex === "ffffff" || hex === "fff" || color.toLowerCase() === "white";
...
_sfc_main$15.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/contact/telegram.vue");
...
const _sfc_main$14 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const gradientId = `whatsapp-gradient-${uniqueId}`;
    const filterId = `whatsapp-filter-${uniqueId}`;
    const isWhiteColor = (color) => {
      if (!color || color === "transparent") return false;
      const hex = color.replace("#", "").toLowerCase();
      return hex === "ffffff" || hex === "fff" || color.toLowerCase() === "white";
...
_sfc_main$14.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/contact/whatsapp.vue");
...
_sfc_main$13.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/bale.vue");
...
_sfc_main$12.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/clubhouse.vue");
...
_sfc_main$11.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/discord.vue");
...
_sfc_main$10.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/facebook.vue");
...
_sfc_main$$.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/igap.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<svg${ssrRenderAttrs(mergeProps({
        ...
        xmlns: "http://www.w3.org/2000/svg",
        "xmlns:svg": "http://www.w3.org/2000/svg"
      }, _attrs))}><defs id="defs11"><linearGradient id="uuid-01439ffa-6fe9-4278-b1eb-3d003607e63c" x1="46.355" y1="221.32899" x2="228.842" y2="38.842999" gradientUnits="userSpaceOnUse" gradientTransform="translate(-27.733,-20.221001)"><stop offset="0" stop-color="#fec053" id="stop2"></stop> <stop offset=".327" stop-color="#ee2740" id="stop4"></stop> <stop offset=".648" stop-color="#ac3d96" id="stop6"></stop> <stop offset="1" stop-color="#5755a5" id="stop8"></stop></linearGradient></defs> <rect x="0" y="0" width="219.73" height="219.73" rx="63.578999" ry="63.578999"${ssrRenderAttr("fill", props.color ? props.color : "url(#uuid-01439ffa-6fe9-4278-b1eb-3d003607e63c)")} id="rect13"></rect> <g id="g21" transform="translate(-27.733,-20.221001)"><path d="m 137.598,68.241 c 20.143,0 22.528,0.077 30.483,0.44 7.355,0.336 11.35,1.565 14.008,2.598 3.521,1.369 6.034,3.003 8.674,5.643 2.64,2.64 4.275,5.153 5.643,8.674 1.033,2.658 2.262,6.653 2.598,14.008 0.363,7.955 0.44,10.341 0.44,30.483 0,20.142 -0.077,22.528 -0.44,30.483 -0.336,7.355 -1.565,11.35 -2.598,14.008 -1.369,3.521 -3.003,6.034 -5.643,8.674 -2.64,2.64 -5.153,4.275 -8.674,5.643 -2.658,1.033 -6.653,2.262 -14.008,2.598 -7.953,0.363 -10.339,0.44 -30.483,0.44 -20.144,0 -22.53,-0.077 -30.483,-0.44 -7.355,-0.336 -11.349,-1.565 -14.008,-2.598 -3.521,-1.369 -6.034,-3.003 -8.674,-5.643 -2.64,-2.64 -4.275,-5.153 -5.643,-8.674 -1.033,-2.658 -2.262,-6.653 -2.598,-14.008 -0.363,-7.955 -0.44,-10.341 -0.44,-30.483 0,-20.142 0.077,-22.529 0.44,-30.483 0.336,-7.355 1.565,-11.35 2.598,-14.008 1.368,-3.521 3.003,-6.034 5.643,-8.674 2.64,-2.64 5.153,-4.275 8.674,-5.643 2.658,-1.033 6.653,-2.262 14.008,-2.598 7.955,-0.363 10.341,-0.44 30.483,-0.44 m 0,-13.592 c -20.488,0 -23.057,0.087 -31.103,0.454 -8.03,0.366 -13.513,1.642 -18.312,3.507 -4.961,1.928 -9.168,4.507 -13.361,8.701 -4.194,4.194 -6.773,8.401 -8.701,13.361 -1.865,4.799 -3.14,10.282 -3.507,18.312 -0.367,8.046 -0.454,10.615 -0.454,31.103 0,20.488 0.087,23.057 0.454,31.103 0.366,8.03 1.642,13.513 3.507,18.312 1.928,4.96 4.507,9.168 8.701,13.362 4.194,4.194 8.401,6.773 13.361,8.701 4.799,1.865 10.282,3.14 18.312,3.507 8.046,0.367 10.615,0.454 31.103,0.454 20.488,0 23.057,-0.087 31.103,-0.454 8.03,-0.366 13.513,-1.642 18.312,-3.507 4.961,-1.928 9.168,-4.507 13.361,-8.701 4.194,-4.194 6.773,-8.401 8.701,-13.362 1.865,-4.799 3.14,-10.282 3.507,-18.312 0.367,-8.046 0.454,-10.615 0.454,-31.103 0,-20.488 -0.087,-23.057 -0.454,-31.103 -0.366,-8.03 -1.642,-13.513 -3.507,-18.312 -1.928,-4.961 -4.507,-9.168 -8.701,-13.361 -4.194,-4.194 -8.401,-6.773 -13.361,-8.701 -4.799,-1.865 -10.282,-3.14 -18.312,-3.507 -8.046,-0.367 -10.615,-0.454 -31.103,-0.454 z"${ssrRenderAttr("fill", textColor.value)} id="path15"></path> <path d="m 137.598,91.348 c -21.395,0 -38.738,17.344 -38.738,38.738 0,21.394 17.344,38.738 38.738,38.738 21.394,0 38.738,-17.344 38.738,-38.738 0,-21.394 -17.344,-38.738 -38.738,-38.738 z m 0,63.884 c -13.888,0 -25.146,-11.258 -25.146,-25.146 0,-13.888 11.258,-25.146 25.146,-25.146 13.888,0 25.146,11.258 25.146,25.146 0,13.888 -11.258,25.146 -25.146,25.146 z"${ssrRenderAttr("fill", textColor.value)} id="path17"></path> <circle cx="177.867" cy="89.817001" r="9.0530005"${ssrRenderAttr("fill", textColor.value)} id="circle19"></circle></g></svg>`);
    };
  }
});
...
_sfc_main$_.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/instagram.vue");
...
_sfc_main$Z.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/linkedin.vue");
...
_sfc_main$Y.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/medium.vue");
...
_sfc_main$X.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/pinterest.vue");
...
_sfc_main$W.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/rubika.vue");
...
_sfc_main$V.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/snapchat.vue");
...
_sfc_main$U.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/threads.vue");
...
_sfc_main$T.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/tiktok.vue");
...
_sfc_main$S.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/twitch.vue");
...
_sfc_main$R.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/x.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<svg${ssrRenderAttrs(mergeProps({
        ...
        role: "img",
        xmlns: "http://www.w3.org/2000/svg"
      }, _attrs))}><path d="M11.214 0A9.646 9.646 0 0 0 8.97.522C5.462 1.787 3.438 4.448 3.167 8.234c-.261 3.647 1.388 6.36 4.45 8.236.777.48 1.683.742 2.564 1.109-.811 1.134-1.666 2.311-2.53 3.524 1.431.977 2.818 1.929 4.232 2.897.13-.166.21-.27.288-.375 1.378-1.902 2.783-3.795 4.144-5.715 1.186-1.684 2.39-3.367 3.473-5.121 1.073-1.736 1.265-3.69.907-5.68-.549-3.06-2.968-5.926-6.281-6.85-.688 1.163-1.679 2.853-1.99 3.366.505.171 1.027.28 1.478.51 1.79.914 2.817 2.362 2.827 4.403.013 2.123-1.007 3.7-2.907 4.548-3.21 1.442-6.176-.664-6.822-3.173-.286-1.092-.263-2.197.271-3.209.53-1.023 1.129-2.007 1.724-3.003z"></path></svg>`);
    };
  }
});
...
_sfc_main$Q.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/virgool.vue");
...
_sfc_main$P.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/youtube.vue");
...
_sfc_main$O.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/SocialMedia/aparat.vue");
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<svg${ssrRenderAttrs(mergeProps({
        ...
        xmlns: "http://www.w3.org/2000/svg",
        "xmlns:svg": "http://www.w3.org/2000/svg"
      }, _attrs))}><defs id="defs7"><linearGradient${ssrRenderAttr("id", gradientId.value)} x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%"${ssrRenderAttr("stop-color", lightColor.value)}></stop> <stop offset="100%"${ssrRenderAttr("stop-color", darkColor.value)}></stop></linearGradient></defs> <path id="path9" d="m 41.6,0 h 136.2 c 23,0 41.6,18.6 41.6,41.6 v 136.1 c 0,23 -18.6,41.6 -41.6,41.6 H 41.6 C 18.6,219.3 0,200.7 0,177.7 V 41.6 C 0,18.6 18.6,0 41.6,0 Z"${ssrRenderAttr("fill", primaryFill.value)}></path> <g id="g29" transform="translate(-25.9,-19.9)"><g id="g15"><path id="path11" d="M 155.5,166.5 H 65.6 c -4.7,0 -9,-3.2 -9.7,-7.8 -0.9,-5.9 3.6,-10.8 9.2,-10.8 H 151 c 1.9,0 3.7,1 4.7,2.7 l 4.5,7.9 c 2.1,3.6 -0.5,8.1 -4.7,8.1 z"${ssrRenderAttr("fill", iconColor.value)}></path> <path id="path13" d="m 215.4,157.2 c 0,5.1 -4.2,9.3 -9.3,9.3 h -35.8 l -10.7,-18.7 h 46.6 c 5.2,0 9.3,4.2 9.3,9.3 z"${ssrRenderAttr("fill", iconColor.value)}></path></g> <g id="g21"><path id="path17" d="m 83.8,168.9 h 9.1 c 4.2,0 6.8,4.5 4.7,8.1 l -10.5,18.3 c -1.7,3 -4.9,4.7 -8.1,4.7 -3.2,0 -3.2,-0.4 -4.7,-1.2 -4.4,-2.6 -6,-8.3 -3.4,-12.8 l 8.3,-14.3 c 1,-1.7 2.7,-2.7 4.7,-2.7 z"${ssrRenderAttr("fill", iconColor.value)}></path> <path id="path19" d="m 157.6,73.2 -41.8,72.4 -1.4,2.3 -1.4,2.3 -8.1,14 H 83.3 l 8.1,-14 2.7,-4.7 47.2,-81.7 c 2.6,-4.4 8.3,-6 12.7,-3.4 4.5,2.6 6,8.3 3.4,12.7 z"${ssrRenderAttr("fill", iconColor.value)}></path></g> <g id="g27"><path id="path23" d="m 145,90.2 -10.8,18.6 -8.1,-14 -1.4,-2.3 -1.4,-2.3 -9.8,-17 c -2.6,-4.4 -1.1,-10.2 3.4,-12.7 4.5,-2.6 10.2,-1 12.7,3.4 l 4.4,7.7 1.4,2.3 1.4,2.3 8.1,14 z"${ssrRenderAttr("fill", iconColor.value)}></path> <path id="path25" d="m 196.9,198.7 c -1.4,0.8 -3,1.2 -4.6,1.2 -3.2,0 -6.4,-1.6 -8.1,-4.7 l -45.6,-79.1 c -1,-1.7 -1,-3.7 0,-5.4 l 4.5,-7.9 c 2.1,-3.6 7.3,-3.6 9.3,0 l 47.9,83 c 2.6,4.5 1,10.2 -3.5,12.8 z"${ssrRenderAttr("fill", iconColor.value)}></path></g></g></svg>`);
    };
  }
});
...
_sfc_main$N.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/app_link.vue");
...
_sfc_main$M.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/balad.vue");
...
_sfc_main$L.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/booksy.vue");
...
_sfc_main$K.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/calendly.vue");
...
_sfc_main$J.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/card.vue");
...
_sfc_main$I.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/chili.vue");
...
_sfc_main$H.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/clock.vue");
...
_sfc_main$G.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/divar.vue");
...
_sfc_main$F.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/etsy.vue");
...
_sfc_main$E.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/figma.vue");
...
_sfc_main$D.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/github.vue");
...
_sfc_main$C.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/googlemeet.vue");
...
const _sfc_main$B = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const primaryColor = computed(() => {
      return props.color || "#0f518c";
    });
    const secondaryColor = computed(() => {
      return props.color ? textColor.value : "#ed0049";
    });
    const textColor = computed(() => {
      if (!props.color) return "#ed0049";
      return isWhiteColor(props.color) ? "#000000" : "#ffffff";
    });
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<svg${ssrRenderAttrs(mergeProps({
        ...
        width: _ctx.size,
        height: _ctx.size
      }, _attrs))}><polygon${ssrRenderAttr("fill", primaryColor.value)} points="32,31 0,31 0,15 8,15 8,19 4,19 4,27 28,27 28,19 24,19 24,15 32,15"></polygon> <path${ssrRenderAttr("fill", secondaryColor.value)} d="M16,6c1.861,0,3.413,1.278,3.858,3h4.072C23.438,5.055,20.079,2,16,2S8.562,5.055,8.069,9h4.072 C12.587,7.278,14.139,6,16,6z"></path> <path${ssrRenderAttr("fill", secondaryColor.value)} d="M16,14c-1.861,0-3.412-1.278-3.858-3H8.124C9.101,15.594,16,23,16,23s6.899-7.406,7.876-12h-4.018 C19.412,12.722,17.861,14,16,14z"></path></svg>`);
    };
  }
});
...
_sfc_main$B.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/linkumap.vue");
...
const _sfc_main$A = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<svg${ssrRenderAttrs(mergeProps({
        id: "uuid-1137a794-4953-47c3-8447-c7447cb7cc97",
        viewBox: "0 0 219.13001 219.13",
        version: "1.1",
        width: _ctx.size,
        height: _ctx.size,
        xmlns: "http://www.w3.org/2000/svg",
        "xmlns:svg": "http://www.w3.org/2000/svg"
      }, _attrs))}><defs id="defs15"></defs> <rect x="0" y="0" width="219.13" height="219.13" rx="63.405998" ry="63.405998"${ssrRenderAttr("fill", props.color || "#058373")} id="rect2"></rect> <g id="g10" transform="translate(-28.440001,-20.597)"><path d="m 191.836,160.662 c -18.389,-0.071 -36.778,-0.198 -55.166,-0.197 -19.052,0.001 -38.103,0.128 -57.155,0.199 -0.569,-0.194 -0.962,-0.03 -1.145,0.562 -0.839,0.472 -0.934,1.282 -0.931,2.115 0.061,16.283 0.128,32.565 0.193,48.848 0.268,1.687 1.359,2.107 2.877,1.869 20.525,0 41.05,0 61.576,0 4.526,0.427 8.867,-0.715 13.142,-1.851 20.393,-5.419 36.704,-24.648 38.523,-45.564 0.166,-1.906 2.205,-5.15 -1.913,-5.981 z"${ssrRenderAttr("fill", textColor.value)} id="path4"></path> <path d="m 126.582,150.438 c 3.243,0.341 4.559,-0.752 4.554,-4.021 -0.05,-31.776 -0.058,-63.553 -0.016,-95.329 0.005,-3.432 -1.614,-4.702 -4.844,-4.71 -14.895,-0.038 -29.789,-0.147 -44.684,-0.187 -1.574,-0.004 -3.433,-0.294 -3.974,1.945 0.007,17.216 0.013,34.433 0.02,51.649 1.766,27.092 21.823,47.802 48.944,50.653 z"${ssrRenderAttr("fill", textColor.value)} id="path6"></path> <path d="m 144.146,150.629 c 16.214,-0.13 32.428,-0.218 48.643,-0.319 2.343,-1.606 1.174,-3.964 0.946,-5.854 -2.912,-24.141 -20.566,-42.39 -44.699,-46.402 -1.641,-0.108 -3.282,-0.215 -4.923,-0.323 -0.662,0.041 -1.324,0.083 -1.986,0.124 -0.749,0.164 -1.117,0.692 -1.119,1.397 -0.039,16.222 -0.062,32.445 -0.091,48.667 -0.004,2.203 1.291,2.724 3.23,2.709 z"${ssrRenderAttr("fill", textColor.value)} id="path8"></path></g></svg>`);
    };
  }
});
...
_sfc_main$A.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/microsoft_bookings.vue");
...
_sfc_main$z.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/nshan.vue");
  return _sfc_setup$z ? _sfc_setup$z(props, ctx) : void 0;
};
const _sfc_main$y = /* @__PURE__ */ defineComponent({
  __name: "reviews",
...
_sfc_main$y.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/reviews.vue");
  return _sfc_setup$y ? _sfc_setup$y(props, ctx) : void 0;
};
const _sfc_main$x = /* @__PURE__ */ defineComponent({
  __name: "snapp",
...
_sfc_main$x.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/snapp.vue");
  return _sfc_setup$x ? _sfc_setup$x(props, ctx) : void 0;
};
const _sfc_main$w = /* @__PURE__ */ defineComponent({
  __name: "square",
...
_sfc_main$w.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/square.vue");
  return _sfc_setup$w ? _sfc_setup$w(props, ctx) : void 0;
};
const _sfc_main$v = /* @__PURE__ */ defineComponent({
  __name: "teams",
...
_sfc_main$v.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/teams.vue");
  return _sfc_setup$v ? _sfc_setup$v(props, ctx) : void 0;
};
const _sfc_main$u = /* @__PURE__ */ defineComponent({
  __name: "trustpilot",
...
_sfc_main$u.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/trustpilot.vue");
  return _sfc_setup$u ? _sfc_setup$u(props, ctx) : void 0;
};
const _sfc_main$t = /* @__PURE__ */ defineComponent({
  __name: "website",
...
_sfc_main$t.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/website.vue");
  return _sfc_setup$t ? _sfc_setup$t(props, ctx) : void 0;
};
const _sfc_main$s = /* @__PURE__ */ defineComponent({
  __name: "yelp",
...
_sfc_main$s.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/yelp.vue");
  return _sfc_setup$s ? _sfc_setup$s(props, ctx) : void 0;
};
const _sfc_main$r = /* @__PURE__ */ defineComponent({
  __name: "zillow",
...
_sfc_main$r.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/zillow.vue");
  return _sfc_setup$r ? _sfc_setup$r(props, ctx) : void 0;
};
const _sfc_main$q = /* @__PURE__ */ defineComponent({
  __name: "zoom",
...
_sfc_main$q.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Business/zoom.vue");
  return _sfc_setup$q ? _sfc_setup$q(props, ctx) : void 0;
};
const _sfc_main$p = /* @__PURE__ */ defineComponent({
  __name: "cashapp",
...
_sfc_main$p.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Payment/cashapp.vue");
  return _sfc_setup$p ? _sfc_setup$p(props, ctx) : void 0;
};
const _sfc_main$o = /* @__PURE__ */ defineComponent({
  __name: "paypal",
...
_sfc_main$o.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Payment/paypal.vue");
  return _sfc_setup$o ? _sfc_setup$o(props, ctx) : void 0;
};
const _sfc_main$n = /* @__PURE__ */ defineComponent({
  __name: "remit",
...
_sfc_main$n.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Payment/remit.vue");
  return _sfc_setup$n ? _sfc_setup$n(props, ctx) : void 0;
};
const _sfc_main$m = /* @__PURE__ */ defineComponent({
  __name: "trustwallet",
...
_sfc_main$m.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Payment/trustwallet.vue");
  return _sfc_setup$m ? _sfc_setup$m(props, ctx) : void 0;
};
const _sfc_main$l = /* @__PURE__ */ defineComponent({
  __name: "zarinpal",
...
_sfc_main$l.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Payment/zarinpal.vue");
  return _sfc_setup$l ? _sfc_setup$l(props, ctx) : void 0;
};
const _sfc_main$k = /* @__PURE__ */ defineComponent({
  __name: "zelle",
...
_sfc_main$k.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Payment/zelle.vue");
  return _sfc_setup$k ? _sfc_setup$k(props, ctx) : void 0;
};
const _sfc_main$j = /* @__PURE__ */ defineComponent({
  __name: "customlink",
...
_sfc_main$j.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Content/customlink.vue");
  return _sfc_setup$j ? _sfc_setup$j(props, ctx) : void 0;
};
const _sfc_main$i = /* @__PURE__ */ defineComponent({
  __name: "dropDown",
...
_sfc_main$i.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Content/dropDown.vue");
  return _sfc_setup$i ? _sfc_setup$i(props, ctx) : void 0;
};
const _sfc_main$h = /* @__PURE__ */ defineComponent({
...
_sfc_main$h.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Content/embeddedvideo.vue");
  return _sfc_setup$h ? _sfc_setup$h(props, ctx) : void 0;
};
const _sfc_main$g = /* @__PURE__ */ defineComponent({
  __name: "featured",
...
_sfc_main$g.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Content/featured.vue");
  return _sfc_setup$g ? _sfc_setup$g(props, ctx) : void 0;
};
const _sfc_main$f = /* @__PURE__ */ defineComponent({
  __name: "file",
...
_sfc_main$f.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Content/file.vue");
  return _sfc_setup$f ? _sfc_setup$f(props, ctx) : void 0;
};
const _sfc_main$e = /* @__PURE__ */ defineComponent({
  __name: "poll",
...
_sfc_main$e.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Content/poll.vue");
  return _sfc_setup$e ? _sfc_setup$e(props, ctx) : void 0;
};
const _sfc_main$d = /* @__PURE__ */ defineComponent({
  __name: "questionbox",
...
_sfc_main$d.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Content/questionbox.vue");
  return _sfc_setup$d ? _sfc_setup$d(props, ctx) : void 0;
};
const _sfc_main$c = /* @__PURE__ */ defineComponent({
  __name: "textSection",
...
_sfc_main$c.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Content/textSection.vue");
  return _sfc_setup$c ? _sfc_setup$c(props, ctx) : void 0;
};
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  __name: "apple_music",
...
_sfc_main$b.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Music/apple_music.vue");
  return _sfc_setup$b ? _sfc_setup$b(props, ctx) : void 0;
};
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  __name: "hoobe",
...
_sfc_main$a.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Music/hoobe.vue");
  return _sfc_setup$a ? _sfc_setup$a(props, ctx) : void 0;
};
...
_sfc_main$9.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Music/linktree.vue");
...
_sfc_main$8.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Music/opensea_color.vue");
...
_sfc_main$7.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Music/podcasts.vue");
...
_sfc_main$6.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Music/poshmark.vue");
...
_sfc_main$5.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Music/spotify.vue");
...
_sfc_main$4.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Music/youtube_music.vue");
  return _sfc_setup$4 ? _sfc_setup$4(props, ctx) : void 0;
};
const useSafeFormStore = () => {
  return computed(() => {
    try {
      return useFormStore();
    } catch (error) {
...
const useIconColorSystem = () => {
  const formStore = useSafeFormStore();
  const isColorPickerActive = computed(() => {
    var _a;
    const iconColor = (_a = formStore.value.iconColor) == null ? void 0 : _a.background;
    return iconColor && iconColor !== "#000000" && iconColor !== "transparent";
  });
  const primaryColor = computed(() => {
    var _a;
    return ((_a = formStore.value.iconColor) == null ? void 0 : _a.background) || "#000000";
  });
  const backgroundColor = computed(() => {
    return isColorPickerActive.value ? "transparent" : void 0;
  });
  const secondaryColor = computed(() => {
    return isColorPickerActive.value ? primaryColor.value : void 0;
  });
...
_sfc_main$3.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Club/luckyegg.vue");
...
_sfc_main$2.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Club/luckydice.vue");
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Club/luckywheel.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/ui/icons/Club/form.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const iconComponentsMap = {
  // Contact icons
  "telegram": _sfc_main$15,
  "email": _sfc_main$18,
  "phone": _sfc_main$16,
  // phone mapped to number
  "website": _sfc_main$t,
  // use actual website icon from Business
  "number": _sfc_main$16,
  "call": _sfc_main$1b,
  "contactcard": _sfc_main$1a,
  "address": _sfc_main$1c,
  "facetime": _sfc_main$17,
  "whatsapp": _sfc_main$14,
  "eitaa": _sfc_main$19,
  // Social Media icons
  "instagram": _sfc_main$_,
  "facebook": _sfc_main$10,
  "tiktok": _sfc_main$T,
  "twitter": _sfc_main$R,
  // twitter mapped to x.vue
  "x": _sfc_main$R,
  "linkedin": _sfc_main$Z,
  "youtube": _sfc_main$P,
  "aparat": _sfc_main$O,
  "discord": _sfc_main$11,
  "snapchat": _sfc_main$V,
  "pinterest": _sfc_main$X,
  "threads": _sfc_main$U,
  "theards": _sfc_main$U,
  // typo variant
  "thread": _sfc_main$U,
  // singular variant
  "clubhouse": _sfc_main$12,
  "twitch": _sfc_main$S,
  "rubika": _sfc_main$W,
  "github": _sfc_main$D,
  // github is in Business
  "bale": _sfc_main$13,
  "igap": _sfc_main$$,
  "medium": _sfc_main$Y,
  "virgool": _sfc_main$Q,
  // Business icons
  "app_link": _sfc_main$N,
  "booksy": _sfc_main$L,
  "calendly": _sfc_main$K,
  "card": _sfc_main$J,
  // شماره کارت / کارت بانکی
  "chili": _sfc_main$I,
  "chili-piper": _sfc_main$K,
  // chili-piper mapped to calendly (placeholder)
  "etsy": _sfc_main$F,
  "reviews": _sfc_main$y,
  "review": _sfc_main$y,
  // singular variant
  ...
  "balad": _sfc_main$M,
  "figma": _sfc_main$E,
  "googlemeet": _sfc_main$C,
  "teams": _sfc_main$v,
  "zoom": _sfc_main$q,
  "trustpilot": _sfc_main$u,
  "zillow": _sfc_main$r,
  "microsoft-bookings": _sfc_main$A,
  // microsoft-bookings mapped to microsoft_bookings
  "microsoft_bookings": _sfc_main$A,
  "microsoftbookings": _sfc_main$A,
  // no separator
  "map": _sfc_main$B,
  // map icon for geographic locations
  "linkumap": _sfc_main$B,
  // linkumap icon for map functionality
  // Payment icons
  "cashapp": _sfc_main$p,
  "paypal": _sfc_main$o,
  "zelle": _sfc_main$k,
  ...
  "reymit": _sfc_main$n,
  // alternative spelling
  "zarinpal": _sfc_main$l,
  "trustwallet": _sfc_main$m,
  // Content icons
  "customlink": _sfc_main$j,
  "dropdown": _sfc_main$i,
  "embeddedvideo": _sfc_main$h,
  "featured": _sfc_main$g,
  "featuredlink": _sfc_main$g,
  // featuredlink mapped to featured
  "file": _sfc_main$f,
  "textsection": _sfc_main$c,
  "text-section": _sfc_main$c,
  // alternative
  "poll": _sfc_main$e,
  "questionbox": _sfc_main$d,
  // Music icons  
  "hoobe": _sfc_main$a,
  "linktree": _sfc_main$9,
  "opensea_color": _sfc_main$8,
  // 'opensea': MusicIcons.opensea, // Removed because it does not exist
  "podcasts": _sfc_main$7,
  "poshmark": _sfc_main$6,
  "spotify": _sfc_main$5,
  "youtube_music": _sfc_main$4,
  "apple_music": _sfc_main$b,
  // Club icons
  "luckyegg": _sfc_main$3,
  "luckydice": _sfc_main$2,
  "luckywheel": _sfc_main$1,
  "form": _sfc_main,
  // Additional mappings for common names - use correct folders
  "code": _sfc_main$f,
  // code mapped to file
  "calendar": _sfc_main$K,
  // calendar mapped to calendly
  "box": _sfc_main$f,
  // box mapped to file  
  "wrench": _sfc_main$N,
  // wrench mapped to app_link
  "appointment": _sfc_main$K,
  // appointment mapped to calendly
  "clock": _sfc_main$H,
  // clock mapped to actual clock icon
  "user": _sfc_main$N,
  // user mapped to app_link
  "creditcard": _sfc_main$J,
  // creditcard mapped to card
  "credit-card": _sfc_main$J,
  // credit-card mapped to card
  "bankcard": _sfc_main$J,
  // bankcard mapped to card
  "bank-card": _sfc_main$J,
  // bank-card mapped to card
  "dollar": _sfc_main$p,
  // dollar mapped to cashapp
  "dollarcircle": _sfc_main$p,
  // dollarcircle mapped to cashapp
  "coins": _sfc_main$p,
  // coins mapped to cashapp
  "image": _sfc_main$f,
  // image mapped to file
  "video": _sfc_main$h,
  // video mapped to embeddedvideo
  "book": _sfc_main$f,
  // book mapped to file
  "userx": _sfc_main$N,
  // userx mapped to app_link (from club)
  "userplus": _sfc_main$N,
  // userplus mapped to app_link (from club)
  "usercheck": _sfc_main$N,
  // usercheck mapped to app_link (from club)
  "alerttriangle": _sfc_main$g,
  // alerttriangle mapped to featured
  "chevrondown": _sfc_main$i,
  // chevrondown mapped to dropDown
  "arrowright": _sfc_main$g,
  // arrowright mapped to featured
  "safari": _sfc_main$t
  // safari mapped to website
};
const useIconComponents = () => {
  const getIconComponent = (iconData) => {
    ...
    if ((iconData == null ? void 0 : iconData.type) === "component") {
...
export { useSafeFormStore as a, useIconColorSystem as b, useIconComponents as u };
//# sourceMappingURL=useIconComponentsMap-DPTCqB5g.mjs.map
