  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isProfileLoaded.value) {
        ...
        _push(`</div> <p class="text-sm text-muted-foreground font-mono">${ssrInterpolate(userPhone.value)}</p></div> <button class="w-full py-3.5 rounded-xl bg-primary text-primary-foreground hover:shadow-lg hover:shadow-primary/20 font-medium transition-all flex items-center justify-center gap-2 group"><i class="ti ti-edit text-lg group-hover:rotate-12 transition-transform"></i> <span>\u0648\u06CC\u0631\u0627\u06CC\u0634 \u067E\u0631\u0648\u0641\u0627\u06CC\u0644</span></button></div>`);
      } else {
      ...
      if (isProfileLoaded.value) {
        ...
        _push(`</div> <p class="text-sm text-muted-foreground pt-1">${ssrInterpolate(userPhone.value)}</p></div> <button class="w-9 h-9 rounded-full bg-primary/10 flex items-center justify-center hover:bg-primary/20 transition-colors"><i class="ti ti-edit text-primary text-lg"></i></button></div>`);
      } else {
...
//# sourceMappingURL=index-Ca5W3vLu.mjs.map
