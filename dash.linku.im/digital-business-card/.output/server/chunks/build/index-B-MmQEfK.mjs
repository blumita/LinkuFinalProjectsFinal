...
import { ref, computed, watch, defineComponent, unref, withCtx, createVNode, resolveDynamicComponent, createTextVNode, createBlock, openBlock, toDisplayString, createCommentVNode, watchEffect, nextTick, useSSRContext } from 'vue';
import { ssrRenderComponent, ssrIncludeBooleanAttr, ssrLooseContain, ssrRenderClass, ssrRenderVNode, ssrRenderAttr, ssrInterpolate, ssrRenderStyle } from 'vue/server-renderer';
...
import { d as _sfc_main$g, u as useLinkStore, _ as _sfc_main$1S, a as _sfc_main$1R, b as _sfc_main$1Q, c as _sfc_main$1P, C as CardNameModal, e as _sfc_main$e, E as EditForms } from './index-6xdMf_wz.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isPageLoading.value) {
        ...
        _push(` <div class="bg-card p-4 sm:p-6 rounded-xl mb-6 border border-border mt-8" data-v-596fdd1c><div class="flex items-center justify-between" data-v-596fdd1c><div data-v-596fdd1c><h3 class="text-base font-semibold text-foreground mb-1" data-v-596fdd1c>\u0641\u0631\u0645 \u062F\u0631\u06CC\u0627\u0641\u062A \u0627\u0637\u0644\u0627\u0639\u0627\u062A</h3> <p class="text-sm text-muted-foreground" data-v-596fdd1c>\u0641\u0639\u0627\u0644\u200C\u0633\u0627\u0632\u06CC \u0641\u0631\u0645 \u0628\u0631\u0627\u06CC \u062C\u0645\u0639\u200C\u0622\u0648\u0631\u06CC \u0627\u0637\u0644\u0627\u0639\u0627\u062A \u0628\u0627\u0632\u062F\u06CC\u062F\u06A9\u0646\u0646\u062F\u06AF\u0627\u0646</p></div> <label class="relative inline-flex items-center cursor-pointer" data-v-596fdd1c><input type="checkbox"${ssrIncludeBooleanAttr(Array.isArray(unref(form).isLeadCaptureEnabled) ? ssrLooseContain(unref(form).isLeadCaptureEnabled, null) : unref(form).isLeadCaptureEnabled) ? " checked" : ""} class="sr-only peer" data-v-596fdd1c> <div class="w-11 h-6 bg-muted peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[&#39;&#39;] after:absolute after:top-[2px] after:start-[2px] after:bg-card after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-primary" data-v-596fdd1c></div></label></div></div> `);
        if (unref(form).links && unref(form).links.length > 0) {
          _push(`<div class="space-y-3 mb-6 mt-8" data-v-596fdd1c><h3 class="text-lg font-semibold text-foreground" data-v-596fdd1c>\u0645\u062D\u062A\u0648\u0627\u06CC \u0627\u0636\u0627\u0641\u0647 \u0634\u062F\u0647</h3> `);
          _push(ssrRenderComponent(unref(draggable), {
            ...
            item: withCtx(({ element: link, index }, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="${ssrRenderClass([{ "shadow-lg scale-[1.02]": isDragging.value }, "bg-card border border-border rounded-xl p-4 flex items-center justify-between hover:bg-muted/20 transition-all duration-200 group"])}" data-v-596fdd1c${_scopeId}><div class="flex items-center gap-3" data-v-596fdd1c${_scopeId}><div class="drag-handle cursor-grab active:cursor-grabbing transition-opacity p-2 -m-2 touch-none" data-v-596fdd1c${_scopeId}><i class="ti ti-grip-vertical text-muted-foreground text-xl" data-v-596fdd1c${_scopeId}></i></div> <div class="w-10 h-10 rounded-lg bg-muted flex items-center justify-center" data-v-596fdd1c${_scopeId}>`);
                if (getIconComponent(link)) {
                  ...
                  _push2(`<img${ssrRenderAttr("src", getSafeIconUrl(link))} class="w-5 h-5 object-contain" alt="icon" data-v-596fdd1c${_scopeId}>`);
                } else {
                  _push2(`<i class="${ssrRenderClass(`ti ti-${getFallbackIcon(link)} text-muted-foreground`)}" data-v-596fdd1c${_scopeId}></i>`);
                }
                _push2(`</div> <div data-v-596fdd1c${_scopeId}><p class="font-medium text-foreground" data-v-596fdd1c${_scopeId}>${ssrInterpolate(getLinkDisplayTitle(link))}</p></div></div> <div class="flex items-center gap-2" data-v-596fdd1c${_scopeId}><button class="w-8 h-8 rounded-lg bg-muted hover:bg-muted-foreground/20 flex items-center justify-center transition-colors" data-v-596fdd1c${_scopeId}><i class="ti ti-edit text-sm text-muted-foreground" data-v-596fdd1c${_scopeId}></i></button> <button class="w-8 h-8 rounded-lg bg-destructive/10 hover:bg-destructive/20 flex items-center justify-center transition-colors" data-v-596fdd1c${_scopeId}><i class="ti ti-trash text-sm text-destructive" data-v-596fdd1c${_scopeId}></i></button></div></div>`);
              } else {
                return [
                  createVNode("div", {
        ...
        _push(` <div class="bg-card mt-4 rounded-xl p-6 border border-border hover:shadow-md transition-shadow" data-v-596fdd1c><div class="flex gap-4 mb-6" data-v-596fdd1c><div class="w-12 h-12 bg-muted/40 rounded-xl flex items-center justify-center border-2 border-dashed border-border/60 hover:border-primary/50 hover:bg-primary/5 transition-colors" data-v-596fdd1c><i class="ti ti-plus text-muted-foreground text-xl" data-v-596fdd1c></i></div> <div class="flex-1" data-v-596fdd1c><h3 class="text-base font-semibold text-foreground mb-2" data-v-596fdd1c>\u0627\u0641\u0632\u0648\u062F\u0646 \u0645\u062D\u062A\u0648\u0627</h3> <p class="text-sm text-muted-foreground leading-relaxed" data-v-596fdd1c>
                \u0627\u0637\u0644\u0627\u0639\u0627\u062A \u062A\u0645\u0627\u0633\u060C \u0634\u0628\u06A9\u0647\u200C\u0647\u0627\u06CC \u0627\u062C\u062A\u0645\u0627\u0639\u06CC\u060C \u0644\u06CC\u0646\u06A9\u200C\u0647\u0627 \u0648 \u0645\u062D\u062A\u0648\u0627\u06CC \u062F\u06CC\u06AF\u0631 \u0631\u0627 \u0628\u0647 \u06A9\u0627\u0631\u062A \u062E\u0648\u062F \u0627\u0636\u0627\u0641\u0647 \u06A9\u0646\u06CC\u062F
              </p></div></div> <button class="w-full bg-primary text-primary-foreground px-6 py-3.5 rounded-xl text-sm font-medium transition-all duration-200 flex items-center justify-center gap-3 hover:bg-primary/90 hover:shadow-lg transform hover:-translate-y-0.5" data-v-596fdd1c><i class="ti ti-plus text-lg" data-v-596fdd1c></i> <span data-v-596fdd1c>\u0627\u0641\u0632\u0648\u062F\u0646 \u0645\u062D\u062A\u0648\u0627</span> <i class="ti ti-arrow-left text-sm" data-v-596fdd1c></i></button></div> <div class="hidden lg:block mt-8" data-v-596fdd1c><div class="flex justify-end" data-v-596fdd1c><button${ssrIncludeBooleanAttr(isSaving.value) ? " disabled" : ""} class="bg-primary text-primary-foreground px-8 py-3.5 rounded-xl text-sm font-semibold transition-all duration-200 flex items-center justify-center gap-2 hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed hover:shadow-md" data-v-596fdd1c>`);
        if (isSaving.value) {
          _push(`<!--[--><svg class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" data-v-596fdd1c><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-596fdd1c></circle> <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-596fdd1c></path></svg> <span class="text-sm font-medium" data-v-596fdd1c>\u062F\u0631 \u062D\u0627\u0644 \u0630\u062E\u06CC\u0631\u0647...</span><!--]-->`);
        } else {
          _push(`<!--[--><i class="ti ti-device-floppy text-lg" data-v-596fdd1c></i> <span class="text-sm font-medium" data-v-596fdd1c>\u0630\u062E\u06CC\u0631\u0647 \u062A\u063A\u06CC\u06CC\u0631\u0627\u062A</span><!--]-->`);
        }
        _push(`</button></div></div></div> <div class="lg:col-span-2 space-y-4 sticky z-0 top-16 h-fit w-full hidden lg:block" data-v-596fdd1c><div class="flex justify-center" data-v-596fdd1c><div class="relative" style="${ssrRenderStyle({ "width": "390px", "height": "844px" })}" data-v-596fdd1c><div class="absolute inset-0 rounded-[40px] border-4 border-gray-800 bg-black shadow-xl" data-v-596fdd1c><div class="absolute top-[15%] -left-[5px] w-[4px] h-5 bg-slate-700 rounded-xl" data-v-596fdd1c></div> <div class="absolute top-[25%] -left-[5px] w-[4px] h-10 bg-slate-700 rounded-xl" data-v-596fdd1c></div> <div class="absolute top-[35%] -left-[5px] w-[4px] h-10 bg-slate-700 rounded-xl" data-v-596fdd1c></div> <div class="absolute top-[35%] -right-[5px] w-[4px] h-16 bg-slate-700 rounded-xl" data-v-596fdd1c></div> <div class="absolute top-3 left-1/2 -translate-x-1/2 w-16 h-5 bg-black rounded-xl z-20" data-v-596fdd1c></div> <div class="absolute inset-2 rounded-[32px] overflow-hidden bg-white" data-v-596fdd1c>`);
        _push(ssrRenderComponent(_component_ClientOnly, null, {
          fallback: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="w-full h-full bg-gray-100 rounded-[28px] flex items-center justify-center" data-v-596fdd1c${_scopeId}><div class="text-gray-500" data-v-596fdd1c${_scopeId}>\u062F\u0631 \u062D\u0627\u0644 \u0628\u0627\u0631\u06AF\u0630\u0627\u0631\u06CC...</div></div>`);
            } else {
              return [
      ...
      _push(` <div class="fixed bottom-0 left-0 right-0 bg-background/95 backdrop-blur-lg border-t border-border p-4 z-40 lg:hidden" data-v-596fdd1c><div class="max-w-4xl mx-auto flex gap-3" data-v-596fdd1c><button class="flex-1 bg-muted text-foreground px-6 py-3 rounded-xl text-sm font-medium transition-all duration-200 flex items-center justify-center gap-2 hover:bg-muted/80" data-v-596fdd1c><i class="ti ti-eye text-lg" data-v-596fdd1c></i> <span data-v-596fdd1c>\u067E\u06CC\u0634\u200C\u0646\u0645\u0627\u06CC\u0634</span></button> <button${ssrIncludeBooleanAttr(isSaving.value) ? " disabled" : ""} class="flex-2 bg-primary text-primary-foreground px-6 py-3 rounded-xl text-sm font-medium transition-all duration-200 flex items-center justify-center gap-2 hover:bg-primary/90 disabled:opacity-50 disabled:cursor-not-allowed" data-v-596fdd1c>`);
      if (isSaving.value) {
        _push(`<!--[--><svg class="animate-spin -ml-1 mr-2 h-4 w-4 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" data-v-596fdd1c><circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4" data-v-596fdd1c></circle> <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z" data-v-596fdd1c></path></svg> <span class="text-sm font-medium" data-v-596fdd1c>\u062F\u0631 \u062D\u0627\u0644 \u0630\u062E\u06CC\u0631\u0647...</span><!--]-->`);
      } else {
        _push(`<!--[--><i class="ti ti-device-floppy text-lg" data-v-596fdd1c></i> <span class="text-sm font-medium" data-v-596fdd1c>\u0630\u062E\u06CC\u0631\u0647 \u062A\u063A\u06CC\u06CC\u0631\u0627\u062A</span><!--]-->`);
      ...
      if (showPreviewMobile.value) {
        _push(`<div class="fixed inset-0 z-[9999] lg:hidden bg-white" data-v-596fdd1c><div class="fixed top-0 left-0 right-0 z-10 bg-white border-b border-gray-200 safe-area-top" data-v-596fdd1c><div class="flex items-center justify-between px-4 py-3" data-v-596fdd1c><button class="flex items-center gap-2 text-gray-700 hover:text-gray-900 transition-colors" data-v-596fdd1c><i class="ti ti-arrow-right text-xl" data-v-596fdd1c></i> <span class="text-sm font-medium" data-v-596fdd1c>\u0628\u0627\u0632\u06AF\u0634\u062A</span></button> <h2 class="text-base font-semibold text-gray-800" data-v-596fdd1c>\u067E\u06CC\u0634\u200C\u0646\u0645\u0627\u06CC\u0634</h2> <div class="w-16" data-v-596fdd1c></div></div></div> <div class="pt-14 h-full w-full bg-white" data-v-596fdd1c>`);
        _push(ssrRenderComponent(_component_ClientOnly, null, {
          fallback: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="w-full h-full bg-white flex items-center justify-center" data-v-596fdd1c${_scopeId}><div class="text-gray-500" data-v-596fdd1c${_scopeId}>\u062F\u0631 \u062D\u0627\u0644 \u0628\u0627\u0631\u06AF\u0630\u0627\u0631\u06CC...</div></div>`);
            } else {
              return [
      ...
      if (showEditSheet.value) {
        _push(`<div class="fixed inset-0 bg-black/50 backdrop-blur flex items-center justify-center z-[60] p-0 lg:p-4" data-v-596fdd1c><div class="bg-background rounded-none lg:rounded-2xl w-full h-full lg:max-w-md lg:h-auto lg:max-h-[90vh] overflow-y-auto overflow-x-hidden lg:shadow-2xl border-0 lg:border border-border" data-v-596fdd1c><div class="flex items-center justify-between p-4 border-b border-border bg-background sticky top-0 z-10" data-v-596fdd1c><button class="text-muted-foreground hover:text-foreground flex items-center gap-2 transition-colors" data-v-596fdd1c><i class="ti ti-arrow-right text-lg" data-v-596fdd1c></i> <span class="text-sm font-medium" data-v-596fdd1c>\u0628\u0631\u06AF\u0634\u062A</span></button> <h3 class="text-base font-semibold text-foreground" data-v-596fdd1c>${ssrInterpolate(getEditSheetTitle())}</h3> <div class="flex items-center gap-2" data-v-596fdd1c>`);
        if (editingLink.value && getEditLinkUrl(editingLink.value)) {
          _push(`<a${ssrRenderAttr("href", getEditLinkUrl(editingLink.value))} target="_blank" class="w-9 h-9 flex items-center justify-center rounded-lg hover:bg-muted text-muted-foreground hover:text-foreground transition-colors" title="\u0645\u0634\u0627\u0647\u062F\u0647 \u0644\u06CC\u0646\u06A9" data-v-596fdd1c><i class="ti ti-external-link text-lg" data-v-596fdd1c></i></a>`);
        } else {
          _push(`<!---->`);
        }
        _push(` `);
        if (editingLink.value) {
          _push(`<button type="button" class="w-9 h-9 flex items-center justify-center rounded-lg hover:bg-destructive/10 text-destructive hover:text-destructive/80 transition-colors" title="\u062D\u0630\u0641" data-v-596fdd1c><i class="ti ti-trash text-lg" data-v-596fdd1c></i></button>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div> <div class="flex-1" data-v-596fdd1c>`);
        if (editingLink.value) {
...
const EditCard = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-596fdd1c"]]);

export { EditCard as E };
//# sourceMappingURL=index-B-MmQEfK.mjs.map
