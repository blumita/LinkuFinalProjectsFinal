...
import { u as useAsyncData, a as _imports_0, b as _sfc_main$2, _ as _imports_1, P as PreviewItems, c as _sfc_main$6, d as _sfc_main$5 } from './LayoutLeadForm-Rod-lE9A.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!isLoading.value) {
        ...
        if ((_a = unref(formData)) == null ? void 0 : _a.singleLink) {
          ...
          _push(`<div class="w-full h-screen flex flex-col overflow-hidden relative scrollbar-hide"${ssrRenderAttr("dir", ((_b = unref(formData)) == null ? void 0 : _b.layout) === "left" ? "ltr" : "rtl")} data-v-fbfba7eb><div class="absolute inset-0 w-full h-full pointer-events-none" style="${ssrRenderStyle({ backgroundColor: getLighterColor((_e = (_d = (_c = unref(formData)) == null ? void 0 : _c.themeColor) == null ? void 0 : _d.background) != null ? _e : "#ffffff"), zIndex: 0, transition: "background-color 0.3s" })}" data-v-fbfba7eb></div> <div class="relative z-10 flex-1 pb-8 overflow-auto scrollbar-hide" data-v-fbfba7eb><div class="${ssrRenderClass([
            "relative w-full bg-gray-200 bg-cover bg-center",
            ((_f = unref(formData)) == null ? void 0 : _f.layout) === "portrait" ? "h-60" : "h-40"
          ])}" data-v-fbfba7eb>`);
          if ((_g = unref(formData)) == null ? void 0 : _g.coverImage) {
            _push(`<div class="absolute inset-0 bg-cover bg-center" style="${ssrRenderStyle(`background-image: url('${unref(formData).coverImage}')`)}" data-v-fbfba7eb></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(` <div class="absolute top-4 ltr:right-4 rtl:left-4 z-20" data-v-fbfba7eb><button type="button" class="w-10 h-10 bg-white/10 backdrop-blur-md rounded-full flex items-center justify-center text-white hover:bg-white/20 transition-all duration-300 border border-white/20" data-v-fbfba7eb><i class="ti ti-dots-vertical text-sm" data-v-fbfba7eb></i></button> <div style="${ssrRenderStyle(showOptionsMenu.value ? null : { display: "none" })}" class="absolute top-12 ltr:right-0 rtl:left-0 bg-white/95 backdrop-blur-lg rounded-xl shadow-2xl border border-white/30 py-2 min-w-[160px] z-30" data-v-fbfba7eb><button type="button" class="w-full text-right px-4 py-3 hover:bg-gray-50/80 flex items-center gap-3 text-gray-700 transition-all duration-200" data-v-fbfba7eb><i class="ti ti-share text-gray-600" data-v-fbfba7eb></i>
                \u0627\u0634\u062A\u0631\u0627\u06A9\u200C\u06AF\u0630\u0627\u0631\u06CC
              </button> <button type="button" class="w-full text-right px-4 py-3 hover:bg-gray-50/80 flex items-center gap-3 text-gray-700 transition-all duration-200" data-v-fbfba7eb><i class="ti ti-flag text-gray-600" data-v-fbfba7eb></i>
                \u06AF\u0632\u0627\u0631\u0634 \u0645\u062D\u062A\u0648\u0627
              </button></div></div> `);
          if (((_h = unref(formData)) == null ? void 0 : _h.layout) === "portrait") {
            _push(`<div class="absolute inset-0" style="${ssrRenderStyle({
              background: `linear-gradient(to bottom,
              transparent 50%,
              ${getLighterColor((_k = (_j = (_i = unref(formData)) == null ? void 0 : _i.themeColor) == null ? void 0 : _j.background) != null ? _k : "#ffffff")} 85%,
              ${getLighterColor((_n = (_m = (_l = unref(formData)) == null ? void 0 : _l.themeColor) == null ? void 0 : _m.background) != null ? _n : "#ffffff")} 100%)`
            })}" data-v-fbfba7eb></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(` `);
          if (((_o = unref(formData)) == null ? void 0 : _o.layout) !== "portrait") {
            _push(`<div class="${ssrRenderClass([
              "absolute -bottom-8 z-10 mx-5",
              ((_p = unref(formData)) == null ? void 0 : _p.layout) === "left" ? "left-1" : ((_q = unref(formData)) == null ? void 0 : _q.layout) === "center" ? "left-1/2 transform -translate-x-1/2" : "right-1"
              // default برای right
            ])}" data-v-fbfba7eb>`);
            if ((_r = unref(formData)) == null ? void 0 : _r.profileImage) {
              _push(`<div class="relative" data-v-fbfba7eb><div class="rounded-full border-4 border-white bg-slate-200 w-28 h-28 overflow-hidden" data-v-fbfba7eb><img${ssrRenderAttr("src", (_s = unref(formData)) == null ? void 0 : _s.profileImage)} class="w-full h-full object-cover" data-v-fbfba7eb></div> `);
              if ((_t = unref(formData)) == null ? void 0 : _t.logoImage) {
                _push(`<div class="${ssrRenderClass([
                  "absolute bottom-3 w-10 h-10 rounded-full shadow-md border-2 border-white overflow-hidden",
                  ((_u = unref(formData)) == null ? void 0 : _u.layout) === "left" ? "-right-3" : "-left-3",
                  "bg-white"
                ])}" data-v-fbfba7eb><img${ssrRenderAttr("src", (_v = unref(formData)) == null ? void 0 : _v.logoImage)} class="w-full h-full object-cover" data-v-fbfba7eb></div>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</div>`);
          ...
          _push(`</div> <div class="${ssrRenderClass([
            "z-10",
            ((_w = unref(formData)) == null ? void 0 : _w.layout) === "center" ? "px-4 py-4 text-center flex flex-col items-center" : ((_x = unref(formData)) == null ? void 0 : _x.layout) === "portrait" ? "px-4 py-3 text-right" : ((_y = unref(formData)) == null ? void 0 : _y.layout) === "left" ? "px-4 py-4 text-left" : "px-4 py-4 text-right"
            // default برای right
          ])}" data-v-fbfba7eb><div class="${ssrRenderClass([
            "space-y-2",
            ((_z = unref(formData)) == null ? void 0 : _z.layout) === "center" ? "mt-6 mx-auto max-w-xs" : ((_A = unref(formData)) == null ? void 0 : _A.layout) === "portrait" ? "mt-4 mx-2" : "mt-8 mx-2"
          ])}" style="${ssrRenderStyle({ color: iconText.value })}" data-v-fbfba7eb>`);
          if ((_B = unref(formData)) == null ? void 0 : _B.name) {
            _push(`<div class="${ssrRenderClass([
              "text-xl font-bold flex items-center",
              ((_C = unref(formData)) == null ? void 0 : _C.layout) === "center" ? "justify-center gap-3" : ((_D = unref(formData)) == null ? void 0 : _D.layout) === "portrait" ? "justify-between" : ((_E = unref(formData)) == null ? void 0 : _E.layout) === "left" ? "justify-start gap-3" : "justify-start gap-3"
              // default
            ])}" data-v-fbfba7eb>`);
            if (((_F = unref(formData)) == null ? void 0 : _F.layout) === "portrait" && ((_G = unref(formData)) == null ? void 0 : _G.logoImage)) {
              _push(`<div class="w-12 h-12 rounded-full shadow-md border border-gray-200 overflow-hidden bg-white flex-shrink-0 order-2" data-v-fbfba7eb><img${ssrRenderAttr("src", (_H = unref(formData)) == null ? void 0 : _H.logoImage)} class="w-full h-full object-cover" data-v-fbfba7eb></div>`);
            } else {
              _push(`<!---->`);
            }
            _push(` <div class="${ssrRenderClass([((_I = unref(formData)) == null ? void 0 : _I.layout) === "portrait" ? "order-1" : "", "flex items-center gap-2"])}" data-v-fbfba7eb>${ssrInterpolate((_J = unref(formData)) == null ? void 0 : _J.name)} <span class="${ssrRenderClass(((_K = unref(formData)) == null ? void 0 : _K.layout) === "left" ? "ml-2" : "mr-2")}" data-v-fbfba7eb>`);
            if (enableBlueTick.value) {
              _push(`<i class="ti ti-rosette-discount-check text-blue-500" data-v-fbfba7eb></i>`);
            } else {
              _push(`<!---->`);
            }
            _push(`</span></div></div>`);
            ...
            _push(`<div class="${ssrRenderClass([
              ...
              ((_L = unref(formData)) == null ? void 0 : _L.layout) === "center" ? "text-2xl justify-center gap-3" : ((_M = unref(formData)) == null ? void 0 : _M.layout) === "portrait" ? "text-xl justify-between" : unref(formData).layout === "left" ? "text-2xl justify-start gap-3" : "text-2xl justify-start gap-3"
              // default
            ])}" style="${ssrRenderStyle({ color: iconText.value })}" data-v-fbfba7eb>`);
            if (unref(formData).layout === "portrait") {
              _push(`<div class="w-12 h-12 rounded-full shadow-md border border-gray-200 overflow-hidden bg-white flex-shrink-0 order-2" data-v-fbfba7eb>`);
              if (unref(formData).logoImage) {
                _push(`<img${ssrRenderAttr("src", unref(formData).logoImage)} class="w-full h-full object-cover" data-v-fbfba7eb>`);
              } else {
                _push(`<!---->`);
              }
              _push(`</div>`);
            ...
            _push(` <div class="${ssrRenderClass([unref(formData).layout === "portrait" ? "order-1" : "", "flex items-center gap-2"])}" data-v-fbfba7eb></div></div>`);
          }
          _push(` `);
          if (unref(formData).job) {
            _push(`<div class="${ssrRenderClass([
              ...
              // default
            ])}" data-v-fbfba7eb><i class="ti ti-briefcase text-sm" style="${ssrRenderStyle({ color: iconColor.value })}" data-v-fbfba7eb></i> ${ssrInterpolate(unref(formData).job)}</div>`);
          } else {
            _push(`<div class="${ssrRenderClass([
          ...
          if (unref(formData).company) {
            _push(`<div class="${ssrRenderClass([
              ...
              unref(formData).layout === "center" ? "justify-center" : unref(formData).layout === "portrait" ? "justify-start" : unref(formData).layout === "left" ? "justify-start" : "justify-start"
              // default
            ])}" data-v-fbfba7eb><i class="ti ti-building text-sm" style="${ssrRenderStyle({ color: iconColor.value })}" data-v-fbfba7eb></i> ${ssrInterpolate(unref(formData).company)}</div>`);
          } else {
            _push(`<div class="${ssrRenderClass([
          ...
          _push(` `);
          if ((_N = unref(formData)) == null ? void 0 : _N.location) {
            _push(`<div class="${ssrRenderClass([
              "text-base font-medium flex items-center gap-1",
              unref(formData).layout === "center" ? "justify-center" : unref(formData).layout === "portrait" ? "justify-start" : unref(formData).layout === "left" ? "justify-start" : "justify-start"
              // default
            ])}" data-v-fbfba7eb><i class="ti ti-map-pin text-sm" style="${ssrRenderStyle({ color: iconColor.value })}" data-v-fbfba7eb></i> ${ssrInterpolate((_O = unref(formData)) == null ? void 0 : _O.location)}</div>`);
          } else {
            _push(`<div class="${ssrRenderClass([
              "text-sm text-black flex items-center gap-1",
              unref(formData).layout === "center" ? "justify-center" : unref(formData).layout === "portrait" ? "justify-start" : unref(formData).layout === "left" ? "justify-start" : "justify-start"
          ...
          if (unref(formData).bio) {
            ...
            ])}" style="${ssrRenderStyle({ "overflow": "hidden", "display": "-webkit-box", "-webkit-line-clamp": "3", "-webkit-box-orient": "vertical", "line-clamp": "3", "white-space": "pre-line" })}" data-v-fbfba7eb>${ssrInterpolate(unref(formData).bio)}</div>`);
          } else {
            _push(`<div class="${ssrRenderClass([
              "text-xs text-black",
              unref(formData).layout === "center" ? "text-center" : unref(formData).layout === "portrait" ? "text-justify" : "text-justify"
          ...
          if (unref(formData).saveContact) {
            ...
            })}" data-v-fbfba7eb><i class="ti ti-download" data-v-fbfba7eb></i> ${ssrInterpolate(unref(formData).saveContact)}</button>`);
          } else {
            _push(`<button disabled class="w-full py-3 rounded-full text-center font-bold text-gray-400 bg-gray-200 flex items-center justify-center gap-2 cursor-not-allowed" data-v-fbfba7eb><div class="w-5 h-5 bg-gray-300 rounded-full animate-pulse" data-v-fbfba7eb></div> <div class="h-4 w-32 bg-gray-300 rounded animate-pulse" data-v-fbfba7eb></div></button>`);
          }
          ...
          if (!unref(formData).removeBranding) {
            _push(`<div class="flex items-center justify-center py-6 px-6" data-v-fbfba7eb><div class="flex items-center gap-2 text-xs text-gray-500 bg-gray-100/50 px-4 py-2 rounded-full border border-gray-200/50 backdrop-blur-sm" data-v-fbfba7eb><img${ssrRenderAttr("src", _imports_0)} alt="Linku Logo" class="w-4 h-4" data-v-fbfba7eb> <span class="font-medium" data-v-fbfba7eb>\u0633\u0627\u062E\u062A\u0647 \u0634\u062F\u0647 \u0628\u0627</span> <span class="font-bold text-gray-700" data-v-fbfba7eb>\u0644\u06CC\u0646\u06A9\u0648</span></div></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`</div> `);
          _push(ssrRenderComponent(__nuxt_component_0, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="space-y-4" data-v-fbfba7eb${_scopeId}><div class="space-y-3" data-v-fbfba7eb${_scopeId}><button class="w-full flex items-center gap-3 p-3 bg-gray-50 hover:bg-blue-50 rounded-lg transition-colors border border-gray-200 hover:border-blue-300" data-v-fbfba7eb${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-fbfba7eb${_scopeId}><i class="ti ti-brand-telegram text-white text-sm" data-v-fbfba7eb${_scopeId}></i></div> <span class="font-medium text-gray-800 text-right flex-1" data-v-fbfba7eb${_scopeId}>\u062A\u0644\u06AF\u0631\u0627\u0645</span></button> <button class="w-full flex items-center gap-3 p-3 bg-gray-50 hover:bg-green-50 rounded-lg transition-colors border border-gray-200 hover:border-green-300" data-v-fbfba7eb${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-fbfba7eb${_scopeId}><i class="ti ti-brand-whatsapp text-white text-sm" data-v-fbfba7eb${_scopeId}></i></div> <span class="font-medium text-gray-800 text-right flex-1" data-v-fbfba7eb${_scopeId}>\u0648\u0627\u062A\u0633\u0627\u067E</span></button> <button class="w-full flex items-center gap-3 p-3 bg-gray-50 hover:bg-pink-50 rounded-lg transition-colors border border-gray-200 hover:border-pink-300" data-v-fbfba7eb${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-fbfba7eb${_scopeId}><i class="ti ti-brand-instagram text-white text-sm" data-v-fbfba7eb${_scopeId}></i></div> <span class="font-medium text-gray-800 text-right flex-1" data-v-fbfba7eb${_scopeId}>\u0627\u06CC\u0646\u0633\u062A\u0627\u06AF\u0631\u0627\u0645</span></button> <button class="w-full flex items-center gap-3 p-3 bg-gray-50 hover:bg-blue-50 rounded-lg transition-colors border border-gray-200 hover:border-blue-300" data-v-fbfba7eb${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-fbfba7eb${_scopeId}><i class="ti ti-brand-linkedin text-white text-sm" data-v-fbfba7eb${_scopeId}></i></div> <span class="font-medium text-gray-800 text-right flex-1" data-v-fbfba7eb${_scopeId}>\u0644\u06CC\u0646\u06A9\u062F\u06CC\u0646</span></button> <button class="w-full flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors border border-gray-200 hover:border-gray-400" data-v-fbfba7eb${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-fbfba7eb${_scopeId}><i class="ti ti-brand-x text-white text-sm" data-v-fbfba7eb${_scopeId}></i></div> <span class="font-medium text-gray-800 text-right flex-1" data-v-fbfba7eb${_scopeId}>\u0627\u06CC\u06A9\u0633</span></button> <button class="w-full flex items-center gap-3 p-3 bg-gray-50 hover:bg-gray-100 rounded-lg transition-colors border border-gray-200 hover:border-gray-400" data-v-fbfba7eb${_scopeId}><div class="w-8 h-8 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-fbfba7eb${_scopeId}><i class="ti ti-copy text-white text-sm" data-v-fbfba7eb${_scopeId}></i></div> <span class="font-medium text-gray-800 text-right flex-1" data-v-fbfba7eb${_scopeId}>\u06A9\u067E\u06CC \u0644\u06CC\u0646\u06A9</span></button></div> <button class="w-full py-3 px-4 bg-gray-200 text-gray-700 rounded-xl font-medium hover:bg-gray-300 transition-colors" data-v-fbfba7eb${_scopeId}>
            \u0627\u0646\u0635\u0631\u0627\u0641
          </button></div>`);
              } else {
                return [
          ...
          _push(ssrRenderComponent(__nuxt_component_0, {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              if (_push2) {
                _push2(`<div class="space-y-6" data-v-fbfba7eb${_scopeId}><div class="space-y-3" data-v-fbfba7eb${_scopeId}><h4 class="font-semibold text-gray-700" data-v-fbfba7eb${_scopeId}>\u0646\u0648\u0639 \u06AF\u0632\u0627\u0631\u0634:</h4> <div class="space-y-2" data-v-fbfba7eb${_scopeId}><label class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors" data-v-fbfba7eb${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(reportType.value, "inappropriate")) ? " checked" : ""} value="inappropriate" class="text-red-500" data-v-fbfba7eb${_scopeId}> <div class="flex items-center gap-2" data-v-fbfba7eb${_scopeId}><div class="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-fbfba7eb${_scopeId}><i class="ti ti-alert-triangle text-white text-xs" data-v-fbfba7eb${_scopeId}></i></div> <span class="text-gray-800" data-v-fbfba7eb${_scopeId}>\u0645\u062D\u062A\u0648\u0627\u06CC \u0646\u0627\u0645\u0646\u0627\u0633\u0628</span></div></label> <label class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors" data-v-fbfba7eb${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(reportType.value, "spam")) ? " checked" : ""} value="spam" class="text-orange-500" data-v-fbfba7eb${_scopeId}> <div class="flex items-center gap-2" data-v-fbfba7eb${_scopeId}><div class="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-fbfba7eb${_scopeId}><i class="ti ti-mail-x text-white text-xs" data-v-fbfba7eb${_scopeId}></i></div> <span class="text-gray-800" data-v-fbfba7eb${_scopeId}>\u0627\u0633\u067E\u0645 \u06CC\u0627 \u062A\u0628\u0644\u06CC\u063A\u0627\u062A</span></div></label> <label class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors" data-v-fbfba7eb${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(reportType.value, "fake")) ? " checked" : ""} value="fake" class="text-blue-500" data-v-fbfba7eb${_scopeId}> <div class="flex items-center gap-2" data-v-fbfba7eb${_scopeId}><div class="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-fbfba7eb${_scopeId}><i class="ti ti-user-x text-white text-xs" data-v-fbfba7eb${_scopeId}></i></div> <span class="text-gray-800" data-v-fbfba7eb${_scopeId}>\u0647\u0648\u06CC\u062A \u062C\u0639\u0644\u06CC</span></div></label> <label class="flex items-center gap-3 p-3 bg-gray-50 rounded-xl cursor-pointer hover:bg-gray-100 transition-colors" data-v-fbfba7eb${_scopeId}><input type="radio"${ssrIncludeBooleanAttr(ssrLooseEqual(reportType.value, "other")) ? " checked" : ""} value="other" class="text-gray-500" data-v-fbfba7eb${_scopeId}> <div class="flex items-center gap-2" data-v-fbfba7eb${_scopeId}><div class="w-6 h-6 rounded-lg flex items-center justify-center flex-shrink-0" style="${ssrRenderStyle({ backgroundColor: iconBg.value })}" data-v-fbfba7eb${_scopeId}><i class="ti ti-dots text-white text-xs" data-v-fbfba7eb${_scopeId}></i></div> <span class="text-gray-800" data-v-fbfba7eb${_scopeId}>\u0633\u0627\u06CC\u0631 \u0645\u0648\u0627\u0631\u062F</span></div></label></div></div> <div class="space-y-3" data-v-fbfba7eb${_scopeId}><h4 class="font-semibold text-gray-700" data-v-fbfba7eb${_scopeId}>\u062A\u0648\u0636\u06CC\u062D\u0627\u062A (\u0627\u062E\u062A\u06CC\u0627\u0631\u06CC):</h4> <textarea placeholder="\u0644\u0637\u0641\u0627\u064B \u062A\u0648\u0636\u06CC\u062D\u0627\u062A \u0628\u06CC\u0634\u062A\u0631\u06CC \u062F\u0631 \u0645\u0648\u0631\u062F \u06AF\u0632\u0627\u0631\u0634 \u062E\u0648\u062F \u0627\u0631\u0627\u0626\u0647 \u062F\u0647\u06CC\u062F..." class="w-full p-4 border border-gray-200 rounded-xl resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" rows="4" data-v-fbfba7eb${_scopeId}>${ssrInterpolate(reportDescription.value)}</textarea></div> <div class="flex gap-3 pt-4 border-t border-gray-200" data-v-fbfba7eb${_scopeId}><button class="flex-1 py-3 px-4 bg-gray-200 text-gray-700 rounded-xl font-medium hover:bg-gray-300 transition-colors" data-v-fbfba7eb${_scopeId}>
              \u0627\u0646\u0635\u0631\u0627\u0641
            </button> <button${ssrIncludeBooleanAttr(!reportType.value) ? " disabled" : ""} class="${ssrRenderClass([{ "bg-gray-300 !text-gray-500 cursor-not-allowed": !reportType.value }, "flex-1 py-3 px-4 rounded-xl font-medium transition-colors text-white hover:opacity-90"])}" style="${ssrRenderStyle(reportType.value ? { backgroundColor: iconBg.value } : { backgroundColor: "#d1d5db" })}" data-v-fbfba7eb${_scopeId}>
              \u0627\u0631\u0633\u0627\u0644 \u06AF\u0632\u0627\u0631\u0634
            </button></div> <p class="text-xs text-gray-500 text-center" data-v-fbfba7eb${_scopeId}>
          ...
          if (unref(formData).isLeadCaptureEnabled) {
            _push(`<div class="fixed inset-0 bg-white/70 bg-opacity-50 z-50 w-full p-4 backdrop-blur-[1px]" style="${ssrRenderStyle({ "display": "grid", "place-items": "center" })}" data-v-fbfba7eb>`);
        ...
        _push(`<div class="fixed inset-0 flex flex-col items-center justify-center bg-white text-black z-50" data-v-fbfba7eb><img${ssrRenderAttr("src", _imports_1)} alt="Logo" class="w-32 h-32 mb-10 object-contain" data-v-fbfba7eb> <div class="flex space-x-3" data-v-fbfba7eb><span class="w-3 h-3 bg-black rounded-full animate-bounce [animation-delay:-0.3s]" data-v-fbfba7eb></span> <span class="w-3 h-3 bg-black rounded-full animate-bounce [animation-delay:-0.15s]" data-v-fbfba7eb></span> <span class="w-3 h-3 bg-black rounded-full animate-bounce" data-v-fbfba7eb></span></div></div>`);
      }
    };
  }
};
...
const _slug_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-fbfba7eb"]]);

export { _slug_ as default };
//# sourceMappingURL=_slug_-cN3bq_Kb.mjs.map
