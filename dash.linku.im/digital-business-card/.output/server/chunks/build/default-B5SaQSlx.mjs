import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { u as useAuthStore, a as useNuxtApp, _ as __nuxt_component_0$3, c as __nuxt_component_0, n as navigateTo, e as __nuxt_component_0$2 } from './server.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderAttr, ssrRenderVNode, ssrRenderSlot, ssrRenderStyle, ssrRenderTeleport } from 'vue/server-renderer';
...
const _sfc_main$9 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "fixed top-0 left-0 right-0 w-full z-50 bg-card/95 backdrop-blur-lg border-b border-border" }, _attrs))}><div class="flex items-center justify-between px-4 py-3">`);
  ...
  setup(__props, { emit: __emit }) {
    ...
    const drawQR = async () => {
      ...
      try {
        ...
        if (!ctx) return;
        const logoSrc = ((_a = selectedSharingProfile.value) == null ? void 0 : _a.avatar) || ((_b = selectedSharingProfile.value) == null ? void 0 : _b.logo) || userAvatar.value;
        const logo = new Image();
        logo.crossOrigin = "anonymous";
        logo.onload = () => {
          var _a2;
    ...
    const downloadQR = async () => {
      ...
      try {
        ...
        link.download = `qr-${((_c = selectedSharingProfile.value) == null ? void 0 : _c.slug) || "profile"}-1000x1000.png`;
        link.click();
...
${profileLink.value}`;
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-8a5f6fd5>`);
      if (!isBottomSheetOpen.value) {
        _push(`<div class="fixed bottom-0 left-0 right-0 bg-card border-t border-border z-40" data-v-8a5f6fd5><div class="flex items-center justify-around h-20 px-6 relative" data-v-8a5f6fd5><!--[-->`);
        ssrRenderList(navItems.value, (item) => {
          _push(`<!--[-->`);
          if (item.isCenter) {
            _push(`<button class="w-16 h-16 bg-primary rounded-3xl flex items-center justify-center shadow-xl -mt-10 transition-all duration-200 hover:scale-105 hover:shadow-2xl" data-v-8a5f6fd5><i class="${ssrRenderClass([item.icon, "text-primary-foreground font-bold text-4xl"])}" data-v-8a5f6fd5></i></button>`);
          } else if (item.avatarUrl) {
            _push(`<a${ssrRenderAttr("href", item.path)} class="flex flex-col items-center justify-center p-3 transition-all duration-200 min-w-12" data-v-8a5f6fd5><div class="${ssrRenderClass([
            ...
            ])}" data-v-8a5f6fd5><img${ssrRenderAttr("src", item.avatarUrl)}${ssrRenderAttr("alt", item.label)} class="w-full h-full object-cover" data-v-8a5f6fd5></div></a>`);
          } else {
            ...
            ])}" data-v-8a5f6fd5><i class="${ssrRenderClass([item.icon, "text-2xl"])}" data-v-8a5f6fd5></i></div>`);
          }
          _push(`<!--]-->`);
        });
        _push(`<!--]--></div></div>`);
      ...
      _push(ssrRenderComponent(__nuxt_component_0$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a, _b;
          if (_push2) {
            _push2(`<div class="sticky top-0 w-full z-10 bg-background lg:bg-card border-b border-border flex-shrink-0 lg:rounded-t-2xl" data-v-8a5f6fd5${_scopeId}><div class="flex items-center justify-between px-6 py-4 lg:py-3" data-v-8a5f6fd5${_scopeId}><h3 class="text-lg font-semibold text-foreground" data-v-8a5f6fd5${_scopeId}>\u0627\u0634\u062A\u0631\u0627\u06A9\u200C\u06AF\u0630\u0627\u0631\u06CC</h3> <button class="w-8 h-8 rounded-full bg-muted hover:bg-muted/80 flex items-center justify-center transition-colors" data-v-8a5f6fd5${_scopeId}><i class="ti ti-x text-foreground text-base" data-v-8a5f6fd5${_scopeId}></i></button></div></div> <div class="flex-1 overflow-y-auto lg:overflow-hidden" data-v-8a5f6fd5${_scopeId}><div class="flex flex-col lg:flex-row lg:h-full" data-v-8a5f6fd5${_scopeId}><div class="lg:w-1/2 lg:border-l lg:border-border p-6 lg:flex lg:flex-col lg:justify-center lg:items-center bg-muted/30" data-v-8a5f6fd5${_scopeId}><div class="flex justify-center mb-6" data-v-8a5f6fd5${_scopeId}><button class="flex items-center gap-2 p-3 bg-background hover:bg-muted/80 rounded-full border border-border min-w-[164px] transition-colors" data-v-8a5f6fd5${_scopeId}><div class="w-7 h-7 rounded-full overflow-hidden flex-shrink-0 ring-2 ring-primary/30" data-v-8a5f6fd5${_scopeId}><img${ssrRenderAttr("src", ((_a = selectedSharingProfile.value) == null ? void 0 : _a.avatar) || userAvatar.value)}${ssrRenderAttr("alt", userName.value)} class="w-full h-full object-cover" data-v-8a5f6fd5${_scopeId}></div> <span class="text-sm font-medium text-foreground truncate flex-1" data-v-8a5f6fd5${_scopeId}>${ssrInterpolate(userName.value)}</span> <i class="ti ti-chevron-down text-muted-foreground flex-shrink-0" data-v-8a5f6fd5${_scopeId}></i></button></div> <div class="flex flex-col items-center justify-center mb-6" data-v-8a5f6fd5${_scopeId}><div class="p-4 rounded-2xl border-2 border-border shadow-lg bg-white" data-v-8a5f6fd5${_scopeId}><canvas width="200" height="200" class="rounded-lg" data-v-8a5f6fd5${_scopeId}></canvas></div></div> <div class="flex justify-center" data-v-8a5f6fd5${_scopeId}><button class="flex items-center gap-3 px-10 py-3 bg-primary text-primary-foreground rounded-full font-semibold text-base hover:opacity-90 transition-opacity shadow-lg" data-v-8a5f6fd5${_scopeId}><i class="ti ti-share-2 text-lg" data-v-8a5f6fd5${_scopeId}></i>
                \u0627\u0634\u062A\u0631\u0627\u06A9\u200C\u06AF\u0630\u0627\u0631\u06CC
              </button></div></div> <div class="lg:w-1/2 p-6 lg:overflow-y-auto" data-v-8a5f6fd5${_scopeId}><div class="lg:hidden space-y-0 bg-card rounded-2xl overflow-hidden border border-border shadow-sm" data-v-8a5f6fd5${_scopeId}><button class="w-full flex items-center gap-3 p-4 hover:bg-muted/50 transition-all border-b border-border" data-v-8a5f6fd5${_scopeId}><div class="w-9 h-9 rounded-xl bg-primary/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-link text-primary text-lg" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-sm" data-v-8a5f6fd5${_scopeId}>\u06A9\u067E\u06CC \u0644\u06CC\u0646\u06A9</span></button> <button class="w-full flex items-center gap-3 p-4 hover:bg-muted/50 transition-all border-b border-border" data-v-8a5f6fd5${_scopeId}><div class="w-9 h-9 rounded-xl bg-primary/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-edit text-primary text-lg" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-sm" data-v-8a5f6fd5${_scopeId}>\u0633\u0641\u0627\u0631\u0634\u06CC\u200C\u0633\u0627\u0632\u06CC \u0644\u06CC\u0646\u06A9</span></button> <button class="w-full flex items-center gap-3 p-4 hover:bg-muted/50 transition-all border-b border-border" data-v-8a5f6fd5${_scopeId}><div class="w-9 h-9 rounded-xl bg-primary/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-qrcode text-primary text-lg" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-sm" data-v-8a5f6fd5${_scopeId}>\u0633\u0641\u0627\u0631\u0634\u06CC\u200C\u0633\u0627\u0632\u06CC \u06A9\u06CC\u0648\u0622\u0631 \u06A9\u062F</span></button> <button class="w-full flex items-center gap-3 p-4 hover:bg-muted/50 transition-all border-b border-border" data-v-8a5f6fd5${_scopeId}><div class="w-9 h-9 rounded-xl bg-primary/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-photo text-primary text-lg" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-sm" data-v-8a5f6fd5${_scopeId}>\u0630\u062E\u06CC\u0631\u0647 \u062F\u0631 \u06AF\u0627\u0644\u0631\u06CC</span></button> <button class="w-full flex items-center gap-3 p-4 hover:bg-muted/50 transition-all border-b border-border" data-v-8a5f6fd5${_scopeId}><div class="w-9 h-9 rounded-xl bg-blue-500/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-message text-blue-500 text-lg" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-sm" data-v-8a5f6fd5${_scopeId}>\u0627\u0631\u0633\u0627\u0644 \u067E\u06CC\u0627\u0645\u06A9</span></button> <button class="w-full flex items-center gap-3 p-4 hover:bg-muted/50 transition-all border-b border-border" data-v-8a5f6fd5${_scopeId}><div class="w-9 h-9 rounded-xl bg-red-500/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-mail text-red-500 text-lg" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-sm" data-v-8a5f6fd5${_scopeId}>\u0627\u0631\u0633\u0627\u0644 \u0627\u06CC\u0645\u06CC\u0644</span></button> <button class="w-full flex items-center gap-3 p-4 hover:bg-muted/50 transition-all border-b border-border" data-v-8a5f6fd5${_scopeId}><div class="w-9 h-9 rounded-xl bg-green-500/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-brand-whatsapp text-green-500 text-lg" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-sm" data-v-8a5f6fd5${_scopeId}>\u0627\u0634\u062A\u0631\u0627\u06A9 \u062F\u0631 \u0648\u0627\u062A\u0633\u0627\u067E</span></button> <button class="w-full flex items-center gap-3 p-4 hover:bg-muted/50 transition-all border-b border-border" data-v-8a5f6fd5${_scopeId}><div class="w-9 h-9 rounded-xl bg-pink-500/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-brand-instagram text-pink-500 text-lg" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-sm" data-v-8a5f6fd5${_scopeId}>\u0627\u0634\u062A\u0631\u0627\u06A9 \u062F\u0631 \u0627\u06CC\u0646\u0633\u062A\u0627\u06AF\u0631\u0627\u0645</span></button> <button class="w-full flex items-center gap-3 p-4 hover:bg-muted/50 transition-all border-b border-border" data-v-8a5f6fd5${_scopeId}><div class="w-9 h-9 rounded-xl bg-blue-500/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-brand-telegram text-blue-500 text-lg" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-sm" data-v-8a5f6fd5${_scopeId}>\u0627\u0634\u062A\u0631\u0627\u06A9 \u062F\u0631 \u062A\u0644\u06AF\u0631\u0627\u0645</span></button> <button class="w-full flex items-center gap-3 p-4 hover:bg-muted/50 transition-all" data-v-8a5f6fd5${_scopeId}><div class="w-9 h-9 rounded-xl bg-muted flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-dots text-muted-foreground text-lg" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-sm" data-v-8a5f6fd5${_scopeId}>\u0631\u0648\u0634\u200C\u0647\u0627\u06CC \u062F\u06CC\u06AF\u0631</span></button></div> <div class="hidden lg:block" data-v-8a5f6fd5${_scopeId}><h4 class="text-sm font-semibold text-muted-foreground mb-4" data-v-8a5f6fd5${_scopeId}>\u0631\u0648\u0634\u200C\u0647\u0627\u06CC \u0627\u0634\u062A\u0631\u0627\u06A9\u200C\u06AF\u0630\u0627\u0631\u06CC</h4> <div class="grid grid-cols-4 gap-3" data-v-8a5f6fd5${_scopeId}><button class="flex flex-col items-center gap-2 p-4 hover:bg-muted/50 rounded-xl transition-all border border-border bg-card" data-v-8a5f6fd5${_scopeId}><div class="w-11 h-11 rounded-xl bg-primary/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-link text-primary text-xl" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-xs text-center" data-v-8a5f6fd5${_scopeId}>\u06A9\u067E\u06CC \u0644\u06CC\u0646\u06A9</span></button> <button class="flex flex-col items-center gap-2 p-4 hover:bg-muted/50 rounded-xl transition-all border border-border bg-card" data-v-8a5f6fd5${_scopeId}><div class="w-11 h-11 rounded-xl bg-primary/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-edit text-primary text-xl" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-xs text-center" data-v-8a5f6fd5${_scopeId}>\u0633\u0641\u0627\u0631\u0634\u06CC \u0644\u06CC\u0646\u06A9</span></button> <button class="flex flex-col items-center gap-2 p-4 hover:bg-muted/50 rounded-xl transition-all border border-border bg-card" data-v-8a5f6fd5${_scopeId}><div class="w-11 h-11 rounded-xl bg-primary/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-qrcode text-primary text-xl" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-xs text-center" data-v-8a5f6fd5${_scopeId}>\u0633\u0641\u0627\u0631\u0634\u06CC QR</span></button> <button class="flex flex-col items-center gap-2 p-4 hover:bg-muted/50 rounded-xl transition-all border border-border bg-card" data-v-8a5f6fd5${_scopeId}><div class="w-11 h-11 rounded-xl bg-primary/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-photo text-primary text-xl" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-xs text-center" data-v-8a5f6fd5${_scopeId}>\u0630\u062E\u06CC\u0631\u0647 QR</span></button> <button class="flex flex-col items-center gap-2 p-4 hover:bg-muted/50 rounded-xl transition-all border border-border bg-card" data-v-8a5f6fd5${_scopeId}><div class="w-11 h-11 rounded-xl bg-blue-500/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-message text-blue-500 text-xl" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-xs text-center" data-v-8a5f6fd5${_scopeId}>\u067E\u06CC\u0627\u0645\u06A9</span></button> <button class="flex flex-col items-center gap-2 p-4 hover:bg-muted/50 rounded-xl transition-all border border-border bg-card" data-v-8a5f6fd5${_scopeId}><div class="w-11 h-11 rounded-xl bg-red-500/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-mail text-red-500 text-xl" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-xs text-center" data-v-8a5f6fd5${_scopeId}>\u0627\u06CC\u0645\u06CC\u0644</span></button> <button class="flex flex-col items-center gap-2 p-4 hover:bg-muted/50 rounded-xl transition-all border border-border bg-card" data-v-8a5f6fd5${_scopeId}><div class="w-11 h-11 rounded-xl bg-green-500/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-brand-whatsapp text-green-500 text-xl" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-xs text-center" data-v-8a5f6fd5${_scopeId}>\u0648\u0627\u062A\u0633\u0627\u067E</span></button> <button class="flex flex-col items-center gap-2 p-4 hover:bg-muted/50 rounded-xl transition-all border border-border bg-card" data-v-8a5f6fd5${_scopeId}><div class="w-11 h-11 rounded-xl bg-pink-500/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-brand-instagram text-pink-500 text-xl" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-xs text-center" data-v-8a5f6fd5${_scopeId}>\u0627\u06CC\u0646\u0633\u062A\u0627\u06AF\u0631\u0627\u0645</span></button> <button class="flex flex-col items-center gap-2 p-4 hover:bg-muted/50 rounded-xl transition-all border border-border bg-card" data-v-8a5f6fd5${_scopeId}><div class="w-11 h-11 rounded-xl bg-blue-500/10 flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-brand-telegram text-blue-500 text-xl" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-xs text-center" data-v-8a5f6fd5${_scopeId}>\u062A\u0644\u06AF\u0631\u0627\u0645</span></button> <button class="flex flex-col items-center gap-2 p-4 hover:bg-muted/50 rounded-xl transition-all border border-border bg-card" data-v-8a5f6fd5${_scopeId}><div class="w-11 h-11 rounded-xl bg-muted flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-dots text-muted-foreground text-xl" data-v-8a5f6fd5${_scopeId}></i></div> <span class="font-medium text-foreground text-xs text-center" data-v-8a5f6fd5${_scopeId}>\u0628\u06CC\u0634\u062A\u0631</span></button></div></div></div></div></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(__nuxt_component_0$1, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="px-4 pb-6 pt-2" data-v-8a5f6fd5${_scopeId}><p class="text-sm text-primary opacity-60 text-center mb-4" data-v-8a5f6fd5${_scopeId}>\u067E\u0631\u0648\u0641\u0627\u06CC\u0644 \u0645\u0648\u0631\u062F \u0646\u0638\u0631 \u062E\u0648\u062F \u0631\u0627 \u0627\u0646\u062A\u062E\u0627\u0628 \u06A9\u0646\u06CC\u062F</p> <div class="space-y-2" data-v-8a5f6fd5${_scopeId}><!--[-->`);
            ssrRenderList(availableProfiles.value, (profile) => {
              var _a, _b;
              _push2(`<div class="${ssrRenderClass([((_a = selectedSharingProfile.value) == null ? void 0 : _a.id) === profile.id ? "bg-primary/5 border-primary" : "bg-secondary border-border hover:bg-accent-bg/30", "flex items-center gap-3 p-3 rounded-2xl border cursor-pointer transition-colors"])}" data-v-8a5f6fd5${_scopeId}><div class="relative w-11 h-11 rounded-full overflow-hidden ring-2 ring-border bg-white" data-v-8a5f6fd5${_scopeId}><img${ssrRenderAttr("src", profile.avatar || "/logo.svg")}${ssrRenderAttr("alt", profile.name)} class="w-full h-full object-cover" data-v-8a5f6fd5${_scopeId}></div> <div class="flex-1" data-v-8a5f6fd5${_scopeId}><div class="flex items-center justify-between mb-0.5" data-v-8a5f6fd5${_scopeId}><div class="flex items-center gap-1.5" data-v-8a5f6fd5${_scopeId}><h3 class="text-sm font-semibold text-primary" data-v-8a5f6fd5${_scopeId}>${ssrInterpolate(userName.value)}</h3> `);
              if (isPro.value) {
                _push2(`<i class="ti ti-rosette-discount-check-filled text-primary text-lg" data-v-8a5f6fd5${_scopeId}></i>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div> `);
              if (((_b = selectedSharingProfile.value) == null ? void 0 : _b.id) === profile.id) {
                _push2(`<span class="text-xs bg-secondary text-primary border border-border px-2 py-0.5 rounded-full font-medium flex items-center gap-1" data-v-8a5f6fd5${_scopeId}><i class="ti ti-check text-xs" data-v-8a5f6fd5${_scopeId}></i>
                  \u067E\u06CC\u0634\u200C\u0641\u0631\u0636
                </span>`);
              } else {
                _push2(`<!---->`);
              }
              _push2(`</div> <div class="flex flex-wrap items-center gap-1.5 text-xs text-foreground" data-v-8a5f6fd5${_scopeId}>`);
              if (userUserName.value) {
                _push2(`<span class="font-medium" data-v-8a5f6fd5${_scopeId}>
                  @${ssrInterpolate(userUserName.value)}</span>`);
              } else {
                _push2(`<!---->`);
              }
            ...
            _push2(`<!--]--></div> <div class="mt-3 pt-3" data-v-8a5f6fd5${_scopeId}><div class="w-full flex items-center justify-between gap-2 p-3 rounded-2xl bg-secondary border-2 border-dashed border-border hover:bg-accent-bg/30 transition-colors" data-v-8a5f6fd5${_scopeId}><div class="flex items-center gap-2 flex-1 cursor-pointer" data-v-8a5f6fd5${_scopeId}><div class="w-11 h-11 rounded-full bg-accent-bg ring-2 ring-border flex items-center justify-center" data-v-8a5f6fd5${_scopeId}><i class="ti ti-plus text-primary text-sm" data-v-8a5f6fd5${_scopeId}></i></div> <span class="text-sm font-medium text-primary" data-v-8a5f6fd5${_scopeId}>
                \u0627\u06CC\u062C\u0627\u062F \u067E\u0631\u0648\u0641\u0627\u06CC\u0644 \u062C\u062F\u06CC\u062F
              </span></div> `);
            if (!isPro.value) {
              _push2(`<div class="bg-primary text-white px-3 py-1 rounded-full text-xs font-semibold cursor-pointer" data-v-8a5f6fd5${_scopeId}>
              \u062E\u0631\u06CC\u062F \u0627\u0634\u062A\u0631\u0627\u06A9
            </div>`);
            } else {
              _push2(`<div class="bg-primary text-white px-3 py-1 rounded-full text-xs font-semibold" data-v-8a5f6fd5${_scopeId}>
              \u06A9\u0627\u0631\u0628\u0631 \u0648\u06CC\u0698\u0647
            </div>`);
            }
            _push2(`</div></div></div>`);
...
const BottomNavigation = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["__scopeId", "data-v-8a5f6fd5"]]);
const _sfc_main$7 = {
  __name: "ShareModal",
  __ssrInlineRender: true,
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const hideBottomNav = computed(() => {
      return route.path.includes("/checkout/order") || route.path.includes("/QR") || route.path.includes("/profile/CustomizeQRPage") || route.path.includes("/dashboard/edit-card") || route.path.includes("/dashboard/activate");
    });
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex bg-background min-h-screen overflow-hidden transition-colors duration-300" }, _attrs))}><div class="flex-1 flex flex-col relative">`);
      ...
      _push(` <div class="${ssrRenderClass([[
        ...
        hideBottomNav.value ? "pb-0" : "pb-20",
        unref(route).path.includes("/checkout") || hideBottomNav.value ? "" : "lg:px-4 px-2"
...
//# sourceMappingURL=default-B5SaQSlx.mjs.map
