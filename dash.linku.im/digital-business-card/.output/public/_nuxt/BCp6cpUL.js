import{k as V,a as Y,r as z,c as v,o as B,C as E,E as F,i as l,f as n,e as r,b as d,d as g,t as f,O as b,P as k,Q as $,X as O}from"#entry";import{_ as U}from"./Cuk9nQEh.js";const G={class:"min-h-screen bg-background"},H={class:"fixed top-0 left-0 right-0 w-full bg-background/95 backdrop-blur-lg border-b border-border z-50",style:{position:"fixed !important",top:"0px !important",left:"0px !important",right:"0px !important","z-index":"50 !important",width:"100% !important"}},Q={class:"flex items-center justify-between px-4 py-3",style:{"pointer-events":"auto !important"}},W={class:"pt-[60px] px-4 py-3"},X={key:0,class:"mb-6"},q={class:"bg-gradient-to-r from-green-500 to-green-600 p-6 rounded-2xl text-white"},J={class:"grid grid-cols-2 gap-4"},K={class:"text-xl font-bold"},Z={class:"text-xl font-bold"},tt={key:1,class:"mb-6"},et={class:"flex items-center gap-3 overflow-x-auto pb-2"},nt={key:2,class:"space-y-4"},st={class:"space-y-3"},ot={key:3,class:"space-y-4"},rt={class:"text-sm font-medium text-muted-foreground px-2"},it={class:"space-y-3"},at={class:"flex items-center justify-between mb-3"},lt={class:"flex items-center gap-3 flex-1"},dt={class:"flex-1"},ut={class:"text-sm text-muted-foreground"},pt={class:"text-left"},ft={class:"font-bold text-lg text-foreground"},ct={class:"flex items-center justify-between pt-3 border-t border-border/20"},mt={class:"flex items-center gap-4 text-xs text-muted-foreground"},gt={key:0},xt={key:1},vt={class:"flex items-center gap-3"},bt=["onClick"],yt={key:4,class:"text-center py-12"},$t=V({__name:"index",setup(wt){const{$axios:j}=Y(),c=z(!0),p=z([]),u=z("all"),M=v(()=>{const e=new Date,t=e.getMonth(),s=e.getFullYear();return u.value==="all"?p.value:p.value.filter(o=>{const i=o.createdAt||o.created_at||o.date;if(!i)return!1;const a=new Date(i);if(isNaN(a.getTime()))return!1;const m=a.getMonth(),w=a.getFullYear();if(u.value==="thisMonth")return m===t&&w===s;if(u.value==="lastMonth"){const h=t===0?11:t-1,P=t===0?s-1:s;return m===h&&w===P}else if(u.value==="lastThreeMonths"){const h=new Date(e);return h.setMonth(t-3),a>=h}return!0})}),N=v(()=>{const e={};return M.value.forEach(t=>{const s=C(t.createdAt||t.created_at||t.date);e[s]||(e[s]=[]),e[s].push(t)}),e}),S=v(()=>{const e=new Date,t=e.getMonth(),s=e.getFullYear();return p.value.filter(o=>{if(!x(o.status))return!1;const i=o.createdAt||o.created_at||o.date;if(!i)return!1;const a=new Date(i);return isNaN(a.getTime())?!1:a.getMonth()===t&&a.getFullYear()===s}).reduce((o,i)=>o+(i.amount||0),0)}),_=e=>{const t=e.planTitle||e.plan||"",s=e.startDate?"تمدید":"خرید";let o=t.trim();if(o.match(/(\d+)\s*(ماه|ماهه)/)){const i=o.match(/(\d+)\s*(ماه|ماهه)/);if(i){const a=i[1];return a==="۱"||a==="1"?`${s} اشتراک ماهانه`:`${s} اشتراک ${a} ماهه`}}if(o.includes("ماهه"))return o.includes("۱")||o.includes("1")||o==="ماهه"?`${s} اشتراک ماهانه`:`${s} اشتراک ${o}`;if(e.planDuration){const i=e.planDuration;return i.includes("۱")||i.includes("1")||i.includes("یک")?`${s} اشتراک ماهانه`:`${s} اشتراک ${i}`}return t?`${s} اشتراک ${t}`:`${s} اشتراک ماهانه`},T=e=>{if(!e)return"-";const t=e.toString().toLowerCase(),s={zarinpal:"زرین‌پال","zarrin pal":"زرین‌پال",zarrinpal:"زرین‌پال",idpay:"آیدی‌پی",mellat:"بانک ملت",parsian:"بانک پاسارگاد",saman:"بانک سامان",melli:"بانک ملی",saderat:"بانک صادرات",card:"کارت بانکی",wallet:"کیف پول",bank:"انتقال بانکی"};for(const[o,i]of Object.entries(s))if(t.includes(o))return i;return e.toString()},y=e=>!e&&e!==0?"0":e.toLocaleString("fa-IR"),C=e=>{try{if(!e)return"—";const t=s=>{const o=["۰","۱","۲","۳","۴","۵","۶","۷","۸","۹"];return s.replace(/\d/g,i=>o[parseInt(i)])};if(typeof e=="string"){const s=e.trim();if(s.includes("/")&&/^\d{4}\/\d{1,2}\/\d{1,2}$/.test(s))return t(s);if(s.includes("-")||s.includes("T")){const i=new Date(s);if(!isNaN(i.getTime()))return t(i.toLocaleDateString("fa-IR"))}const o=new Date(s);if(!isNaN(o.getTime()))return t(o.toLocaleDateString("fa-IR"))}return e instanceof Date&&!isNaN(e.getTime())?t(e.toLocaleDateString("fa-IR")):"—"}catch{return"—"}},x=e=>{if(!e)return!1;const t=e?.toString().toLowerCase();return["موفق","successful","success","completed","paid","تکمیل شده","پرداخت شده","confirmed","تایید شده","done","انجام شده","verified","تایید شده","ok","200","true","1"].some(o=>t?.includes(o))},D=v(()=>p.value.filter(e=>x(e.status)).reduce((e,t)=>e+(t.amount||0),0)),A=v(()=>p.value.filter(e=>x(e.status)).length);v(()=>{const e=A.value;return e===0?0:Math.round(D.value/e)});const I=async()=>{c.value=!0;try{const t=await j.get("transactions/list");t.data?.data?p.value=t.data.data:Array.isArray(t.data)&&(p.value=t.data)}catch{}finally{c.value=!1}},R=async e=>{try{const t=x(e.status),s=document.createElement("iframe");s.style.position="fixed",s.style.top="-9999px",s.style.width="500px",s.style.height="450px",s.style.visibility="hidden",document.body.appendChild(s);const o=s.contentWindow.document;o.open(),o.write(L(e,t)),o.close(),s.onload=async()=>{setTimeout(async()=>{try{const i=(await O(async()=>{const{default:w}=await import("./B0tyYwQk.js");return{default:w}},[],import.meta.url)).default,a=await i(s.contentDocument.body,{backgroundColor:"#ffffff",useCORS:!0,allowTaint:!0,scale:2,logging:!1}),m=document.createElement("a");m.download=`receipt_${e.referenceId||e.ref||e.id}.png`,m.href=a.toDataURL("image/png"),m.click(),document.body.removeChild(s)}catch{document.body.removeChild(s)}},500)}}catch{alert("خطا در دانلود رسید. لطفاً دوباره تلاش کنید.")}},L=(e,t)=>{const s=window.location.origin+"/logo/logo.png",o=i=>i.replace(/اشتراک\s*ماهانه|ماهانه/gi,"یکماهه");return`
    <html dir="rtl">
      <head>
        <meta charset="UTF-8">
      ...
      <body>
        <div class="receipt">
          ...
          <div class="table">
            ...
            <div class="row">
              <span>تاریخ:</span>
              <span>${C(e.createdAt||e.created_at||e.date)}</span>
            </div>
